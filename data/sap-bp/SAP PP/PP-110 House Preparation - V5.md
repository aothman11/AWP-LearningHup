...
| 1 | Achieve the preparation plan on time | S | H |
| 2 | House prepared in cost effective manner | S | H |
| 3 | All material movements & cost allocated per house per cycle | S | H |

### Business Process Description

In this process, the rearing/laying farm team handle the process of house preparation start from preparation plan to finalizing the house to be ready for placement.

| Process Characteristics |
| --- |
| Process Trigger | New production cycle created |
| Process Input | Production orders |
| Process Output | Production order confirmations per house that preparation operations are completed & Component consumption per order |
| Process Owner | Rearing Farm Responsible / Laying Farm Responsible |
| Process Volumes | Broiler: 980 order / cycle. (8.49 Cycle / Year) Approximately 28 order per day. Parent - Laying 319 order / yearly cycle. One house per day Parent - Rearing 115 order / 2.2 cycle per year. One house every 2 days. C Layer – Laying 36 order / yearly cycle. Six houses every 3 month. C Layer – Rearing 12 order / 2.6 cycle per year. Six houses every 3 month. GP – Rearing 48 Order / Cycle. (2 GP Cycle / Year). GP – Laying 32 Order / Cycle. (1 GP Cycle / Year). |
...
| 010 | Check the preparation plan | COOIS ZPPH3 | Monitor Production/ Planned Orders | Check the preparation plan | Department Planner |
| 020 | Adjust operations dates | CO02 | Change Production Order | Adjust operations dates and names, add or remove operations | Department Planner |
| 030 | Request required preparation components. | ME21N | Create Purchase Order | Request required preparation components from Central store plant using STO to farm store location. On a weekly basis. | PHD Responsible |
| 040 | Approval by PHD manager to STO | ME29N | Release Purchase Order | Approval by PHD manager to STO | PHD Manager |
| 050 | Post Goods Issue | MIGO_GI | Post Goods Movement | Post Goods Issue to STO (Mvt 351) | Stock Keeper |
| 060 | Goods receipt in farm store location | MIGO_GR | Post Goods Movement | Goods receipt in farm store location (Mvt 101) | Farm Responsible |
| 070 | Confirm Preparation Operation | CO11N | Confirm Production Order Operation | Confirm operation & backflush components (MVT 261) | Department Planner |
| 080 | GR production Order | CO11N | Confirm Production Order Operation | Do confirmation for final operation and do automatic goods receipt | Department Planner |
| 090 | Production Order TECO | CO02 | Change Production Order | Set Technically Complete status to production order | Department Planner |
| 100 | Inspection Lot UD | QA32 | Give Usage Decision | Give the usage decision to the inspection lot, it will mark the completion of QM Data | Department Planner |
| 110 | **"Growing" Business Processes** | ** ** | ** ** | **"Growing" Business Processes** | **Farm Responsible** |
| Output | Production order confirmations per house that preparation operations are completed & Component consumption per order |  |  |  |  |
...
| Dulfa | 2 | Parent - Production Planner |
| Wadi | 3 | Parent - Production Planner |
| Shery | 5 | Parent - Production Planner |
| Watania 1 – Main office | 1 | Parent - Production Planner |
| Watania 1 – Main office | 1 | C Layer – Production Planner |
| Watania 1 | 8 | C Layer – Production Planner |
| Jouf | 8 | GP – Production Planner |
| Butain1 | 3 | Broiler – Production Planner |
| Butain2 | 3 | Broiler – Production Planner |
| Butain3 | 3 | Broiler – Production Planner |
| Butain5 | 3 | Broiler – Production Planner |
| Butain 8 | 3 | Broiler – Production Planner |
| Butain 9 | 3 | Broiler – Production Planner |
| Butain11 | 3 | Broiler – Production Planner |
| Shmalia | 3 | Broiler – Production Planner |
| Watania 1 | 3 | Broiler – Production Planner |
| Watania 2 | 3 | Broiler – Production Planner |

### Operational Decisions or Logic within the Process

- The items will be issued as backflush

- Production order will always be created for one house only having target quantity as 1.

### Legal Considerations and Company-Specific Policies

- Two approval steps on this STO PHD material coordinator & PHD manager

- Around 24 house prepared day.
...
| 1 | Confirming operations on time | Actual time / planned time % | 95% |
...
| 2 | PO Release Strategy | MM-PUR-PO |
