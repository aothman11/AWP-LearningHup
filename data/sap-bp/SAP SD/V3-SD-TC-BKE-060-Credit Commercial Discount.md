# V3-SD-TC-BKE-060-Credit Commercial Discount

| V3-TC-SD-BKE-005-Credit Memo Commercial Discount |
| --- |
...
| **Process Name** | Credit Commercial Discount Processing |
| --- | --- |
| **Test pre-conditions** | Master data created (customers , materials and conditions) |
| **Test Type** | Manual |
| **TC Description** | Testing of Credit Memo Processing Credit Commercial Discount Order type  YCR5 |
