# V3-SD-TC-BKE-070-Credit Near Expire Discount

| **V****3****-****TC-SD-B****KE****-00****6****-****Credit**** Memo-****Near Expire Discount** |
| --- |
...
| **Process Name** | Credit Near Expire Discount Processing |
| --- | --- |
| **Test pre-conditions** | Master data created (customers , materials and conditions) |
| **Test Type** | Manual |
| **TC Description** | Testing of Credit Memo Processing Credit Memo Near Expire Discount Order type  YCR6 |
