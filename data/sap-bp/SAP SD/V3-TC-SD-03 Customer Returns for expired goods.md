# V3-TC-SD-03 Customer Returns for expired goods

| V3-TC-SD-BDD-003 Customer Returns for expired goods |
| --- |
...
| **Test Type** | Manual |
| **TC Description** | Testing of Customer Returns for Expired with reference Order type  YRE3 |
