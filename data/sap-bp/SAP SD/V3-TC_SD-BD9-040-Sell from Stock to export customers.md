# V3-TC_SD-BD9-040-Sell from Stock to export customers

| V3-TC-SD-BD9-003-Sell from Stock to export customers |
| --- |
...
| **Test Type** | Manual |
| **TC Description** | Testing of sell from stock to export customers Sales area   1000/30/00 Order type  YOR3 |
