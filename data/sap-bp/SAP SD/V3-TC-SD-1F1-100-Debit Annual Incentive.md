# V3-TC-SD-1F1-100-Debit Annual Incentive

| V3-TC-SD-1F1-009-debit Memo-Debit Annual Incentive |
| --- |
...
| **Process Name** | Debit Annual Incentive Processing |
| --- | --- |
| **Test pre-conditions** | Master data created (customers , materials and conditions) |
| **Test Type** | Manual |
| **TC Description** | Testing of Debit Annual Incentive Processing Debit Annual Incentive Order type  YDR9 |
