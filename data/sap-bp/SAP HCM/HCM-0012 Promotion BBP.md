# HCM-0012 Promotion BBP

| **HCM****-0****01****: ****promotion ****reqeust**** application** |
| --- |
...
The request will be approved by *Line Manager, Department Manager, and Sector VP* of the subject employee. The Position selected by the Manager it has to be a Vacant Position not filled or to be filled by another employee.
