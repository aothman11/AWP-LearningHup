...
export const processes: Process[] = [
  ...
  // ── TM: Create Freight Order ─────────────────────────────────────────────
  {
    ...
    descriptionEN: "Retrieve, assign, and execute a freight order in SAP TM: assign driver and truck, set execution status, and complete the delivery.",
    descriptionAR: "استرجاع وتعيين وتنفيذ أمر الشحن في SAP TM: تعيين السائق والشاحنة وضبط حالة التنفيذ وإتمام التسليم.",
    module: "TM",
    roles: ["TM Planner"],
    steps: [
      {
  ...
  // ── TM: Create Sales Order ────────────────────────────────────────────────
  {
    ...
    descriptionEN: "Create a distributor sales order in SAP using VA01, entering items, quantities, and shipping details to initiate the outbound delivery process.",
    descriptionAR: "إنشاء أمر مبيعات للموزع في SAP باستخدام VA01 مع إدخال الأصناف والكميات وتفاصيل الشحن لبدء عملية التسليم الصادر.",
    module: "TM",
  ...
  // ── TM: Create Outbound Delivery ─────────────────────────────────────────
  {
    ...
    descriptionEN: "Create an outbound delivery from a sales order via VL10C, pick goods, and post goods issue to complete the warehouse outbound process.",
    descriptionAR: "إنشاء تسليم صادر من أمر مبيعات عبر VL10C وانتقاء البضائع وترحيل إصدار البضائع لإتمام عملية المخرجات من المستودع.",
    module: "TM",
  ...
  // ── TM: Customer Pickup Freight Order ────────────────────────────────────
  {
    ...
    descriptionEN: "Create a customer self-pickup freight order in the TM cockpit by selecting freight units and assigning pickup details.",
    descriptionAR: "إنشاء أمر شحن لاستلام العميل بنفسه في لوحة TM عبر اختيار وحدات الشحن وتعيين تفاصيل الاستلام.",
    module: "TM",
    roles: ["TM Planner"],
    steps: [
      {
  ...
  // ── TM: Create Internal Settlement Document (ISD) ────────────────────────
  {
    ...
    descriptionEN: "Create an Internal Settlement Document in SAP TM by selecting forwarding orders and generating the internal settlement for inter-company freight charges.",
    descriptionAR: "إنشاء مستند التسوية الداخلية في SAP TM بتحديد أوامر الشحن وإنشاء التسوية الداخلية لرسوم الشحن بين الشركات.",
    module: "TM",
  ...
  // ── TM: Cancel ISD Document ───────────────────────────────────────────────
  {
    ...
    descriptionEN: "Locate and cancel an Internal Settlement Document in the SAP TM Forwarding Settlements Worklist when a correction or reversal is needed.",
    descriptionAR: "تحديد وإلغاء مستند التسوية الداخلية في قائمة عمل تسويات الشحن في SAP TM عند الحاجة إلى تصحيح أو عكس.",
    module: "TM",
    roles: ["TM Planner", "Accounts Payable"],
    steps: [
      {
  ...
  // ── TM: Create Transportation Resource (Truck) ───────────────────────────
  {
    ...
    descriptionEN: "Define a truck as a transportation resource in SAP TM by entering the truck type, transportation details, driver assignment, and capacity.",
    descriptionAR: "تعريف شاحنة كمورد نقل في SAP TM بإدخال نوع الشاحنة وتفاصيل النقل وتعيين السائق والسعة.",
    module: "TM",
  ...
  // ── TM: Create Transportation Lane ───────────────────────────────────────
  {
    ...
    descriptionEN: "Define a transportation lane between two locations in SAP TM, specifying the means of transport, distance, and transit duration.",
    descriptionAR: "تعريف مسار نقل بين موقعين في SAP TM مع تحديد وسيلة النقل والمسافة ومدة العبور.",
    module: "TM",
    roles: ["TM Administrator"],
    steps: [
      {
  ...
  // ── TM: Create Driver ─────────────────────────────────────────────────────
  {
    ...
    descriptionEN: "Create a driver record in SAP TM by assigning the driver role to a person and entering personal data and license details.",
    descriptionAR: "إنشاء سجل سائق في SAP TM عبر تعيين دور السائق لشخص وإدخال بياناته الشخصية وتفاصيل رخصة القيادة.",
    module: "TM",
  ...
  // ── TM: Display Location Master Data ─────────────────────────────────────
  {
    ...
    descriptionEN: "Search and display location master data in SAP TM to verify address, geo-coordinates, and business partner details.",
    descriptionAR: "البحث عن بيانات رئيسية للموقع وعرضها في SAP TM للتحقق من العنوان والإحداثيات الجغرافية وبيانات شريك الأعمال.",
    module: "TM",
  ...
  // ── TM: Change STO Shipping Point ────────────────────────────────────────
  {
    ...
    descriptionEN: "Update the shipping point on a Stock Transfer Order (STO) via ME22N to align with the correct dispatch location.",
    descriptionAR: "تحديث نقطة الشحن في أمر نقل المخزون (STO) عبر ME22N لمطابقة موقع الإرسال الصحيح.",
    module: "TM",
  ...
  // ── TM: Invoice Posting via MIRO ─────────────────────────────────────────
  {
    ...
    descriptionEN: "Post a logistics service provider invoice in SAP using MIRO, referencing the freight order, entering tax, and completing the AP posting.",
    descriptionAR: "ترحيل فاتورة مزود خدمة اللوجستيات في SAP باستخدام MIRO مع الإشارة إلى أمر الشحن وإدخال الضريبة وإتمام ترحيل الحسابات الدائنة.",
    module: "TM",
  ...
  // ── TM: Fresh Shipping Process ────────────────────────────────────────────
  {
    ...
    descriptionEN: "Execute the daily fresh product shipping process: select truck and driver by region, create outbound delivery, create waybill in TM cockpit, and send bayan to customer.",
    descriptionAR: "تنفيذ عملية شحن المنتجات الطازجة اليومية: اختيار الشاحنة والسائق حسب المنطقة وإنشاء توصيل صادر وإنشاء بوليصة الشحن في لوحة TM وإرسال البيان للعميل.",
    module: "TM",
  ...
  // ── TM: Maintain Shipping Condition ──────────────────────────────────────
  {
    ...
    descriptionEN: "Set or update the shipping condition and means of transport on a sales order to ensure correct freight order generation in SAP TM.",
    descriptionAR: "ضبط أو تحديث شرط الشحن ووسيلة النقل في أمر المبيعات لضمان إنشاء أمر الشحن الصحيح في SAP TM.",
    module: "TM",
  ...
  // ── TM: Transfer SO via External Work ────────────────────────────────────
  {
    ...
    descriptionEN: "Assign an external work order to a sales order in TM and create a freight order for an external carrier to fulfil the delivery.",
    descriptionAR: "تعيين أمر عمل خارجي لأمر مبيعات في TM وإنشاء أمر شحن لناقل خارجي لتنفيذ التوصيل.",
    module: "TM",
    roles: ["TM Planner", "Sales Representative"],
    steps: [
      {
  ...
  // ── TM: Transfer SO via Al Wataniyah / External Client ───────────────────
  {
    ...
    descriptionEN: "Assign a sales order to Al Wataniyah carrier or an external client in the TM cockpit and issue the required shipping documents.",
    descriptionAR: "تعيين أمر مبيعات لناقل الوطنية أو عميل خارجي في لوحة TM وإصدار وثائق الشحن المطلوبة.",
    module: "TM",
    roles: ["TM Planner", "Sales Representative"],
    steps: [
      {
  ...
  // ── TM: Waiting Fees Calculation ─────────────────────────────────────────
  {
    ...
    descriptionEN: "Record loading and unloading timestamps on a freight order to trigger automatic waiting-fee calculation and settlement in SAP TM.",
    descriptionAR: "تسجيل أوقات بدء وانتهاء التحميل والتفريغ في أمر الشحن لتشغيل احتساب رسوم الانتظار وتسويتها تلقائياً في SAP TM.",
    module: "TM",
    roles: ["TM Planner"],
    steps: [
      {
  ...
  // ── TM: Create Waybill for External Client ────────────────────────────────
  {
    ...
    descriptionEN: "Open the external client freight order in SAP TM, create a waybill (Bayan), and print or send it to the customer.",
    descriptionAR: "فتح أمر شحن العميل الخارجي في SAP TM وإنشاء بوليصة الشحن (البيان) وطباعتها أو إرسالها للعميل.",
    module: "TM",
    roles: ["TM Planner"],
    steps: [
      {
  ...
  // ── TM: Add & Edit Prices on Waybill ─────────────────────────────────────
  {
    ...
    descriptionEN: "Enter and edit delivery prices on the Al Wataniyah waybill by navigating document flow to the DTR and submitting the invoice.",
    descriptionAR: "إدخال وتعديل أسعار التوصيل على بوليصة الوطنية بالتنقل عبر تدفق المستند إلى DTR وتقديم الفاتورة.",
    module: "TM",
    roles: ["TM Planner", "Accounts Payable"],
    steps: [
      {
  ...
  // ── TM: Group Logistics – Full TM Process ────────────────────────────────
  {
    ...
    descriptionEN: "End-to-end group logistics process: select frozen freight order in TM cockpit, create internal settlement document (ISD), and verify settlement.",
    descriptionAR: "عملية لوجستيات المجموعة الكاملة: اختيار أمر الشحن المجمّد في لوحة TM وإنشاء مستند التسوية الداخلية والتحقق من التسوية.",
    module: "TM",
    roles: ["TM Planner", "Accounts Payable"],
    steps: [
      {
  ...
  // ── TM: Verify Delivery Transport Mode ────────────────────────────────────
  {
    ...
    descriptionEN: "Open a delivery document and check the Shipping tab to confirm the correct transport mode; correct and save if needed.",
    descriptionAR: "فتح مستند التسليم والتحقق من تبويب الشحن للتأكد من صحة طريقة النقل وتصحيحها وحفظها عند الحاجة.",
    module: "TM",
    roles: ["TM Planner", "Warehouse Staff"],
    steps: [
      {
  ...
  {
    id: "pp-budget-yearly-planning",
    icon: "📊",
    duration: "1–2 days",
    titleEN: "Budget Yearly Planning",
    titleAR: "التخطيط السنوي للميزانية",
    descriptionEN: "Transfer the annual sales plan from CO-PA to SOP, update production plans, run Long-Term Planning (LTP) scenarios, and evaluate capacity requirements for yearly budget purposes.",
    descriptionAR: "نقل خطة المبيعات السنوية من CO-PA إلى SOP وتحديث خطط الإنتاج وتشغيل سيناريوهات التخطيط طويل الأمد وتقييم متطلبات الطاقة الإنتاجية لأغراض الميزانية السنوية.",
    module: "PP",
    ...
    steps: [
      {
        id: "pp-budget-s1",
        stepNumber: 1,
        titleEN: "Transfer Sales Plan from CO-PA to SOP",
        titleAR: "نقل خطة المبيعات من CO-PA إلى SOP",
        tCode: "KE1E",
        role: "Production Planner",
        whatToDoEN: "Run KE1E to transfer the sales plan from CO-PA to SOP version A00 for the planning year.",
        whatToDoAR: "شغّل KE1E لنقل خطة المبيعات من CO-PA إلى SOP الإصدار A00 لسنة التخطيط.",
        whatSAPDoesEN: "SAP copies PA plan data into SOP as sales quantities and revenues.",
        whatSAPDoesAR: "ينسخ SAP بيانات خطة PA إلى SOP كأرقام مبيعات وإيرادات.",
        expectedOutputEN: "Sales plan transferred to SOP version A00.",
        expectedOutputAR: "خطة المبيعات منقولة إلى SOP الإصدار A00.",
      },
      {
        id: "pp-budget-s2",
        stepNumber: 2,
        titleEN: "Update SOP Production Plan",
        titleAR: "تحديث خطة الإنتاج في SOP",
        tCode: "MC88",
        role: "Production Planner",
        whatToDoEN: "Open MC88 and update the production plan in version A00 to align with the transferred sales quantities.",
        whatToDoAR: "افتح MC88 وحدّث خطة الإنتاج في الإصدار A00 لتتوافق مع كميات المبيعات المنقولة.",
        whatSAPDoesEN: "SAP updates the SOP production plan figures for the planning horizon.",
        whatSAPDoesAR: "يحدّث SAP أرقام خطة إنتاج SOP لأفق التخطيط.",
        expectedOutputEN: "Production plan updated in SOP.",
        expectedOutputAR: "خطة الإنتاج محدّثة في SOP.",
      },
      {
        id: "pp-budget-s3",
        stepNumber: 3,
        titleEN: "Transfer to Demand Management",
        titleAR: "النقل إلى إدارة الطلب",
        tCode: "MC74/MC75",
        role: "Production Planner",
        whatToDoEN: "Use MC74/MC75 to transfer the SOP plan to demand management as an inactive version (PIRs).",
        whatToDoAR: "استخدم MC74/MC75 لنقل خطة SOP إلى إدارة الطلب كإصدار غير نشط (PIRs).",
        whatSAPDoesEN: "SAP creates Planned Independent Requirements (PIRs) in demand management.",
        whatSAPDoesAR: "ينشئ SAP متطلبات مستقلة مخططة (PIRs) في إدارة الطلب.",
        expectedOutputEN: "PIRs created in demand management.",
        expectedOutputAR: "PIRs منشأة في إدارة الطلب.",
      },
      {
        id: "pp-budget-s4",
        stepNumber: 4,
        titleEN: "Check PIRs After Transfer",
        titleAR: "التحقق من PIRs بعد النقل",
        tCode: "MD63",
        role: "Production Planner",
        whatToDoEN: "Run MD63 to verify the transferred PIRs are correct in demand management.",
        whatToDoAR: "شغّل MD63 للتحقق من صحة PIRs المنقولة في إدارة الطلب.",
        whatSAPDoesEN: "SAP displays the PIR list for review.",
        whatSAPDoesAR: "يعرض SAP قائمة PIR للمراجعة.",
        expectedOutputEN: "PIRs verified and correct.",
        expectedOutputAR: "PIRs محققة وصحيحة.",
      },
      {
        id: "pp-budget-s5",
        stepNumber: 5,
        titleEN: "Create LTP Scenario",
        titleAR: "إنشاء سيناريو التخطيط طويل الأمد",
        tCode: "MS31",
        role: "Production Planner",
        whatToDoEN: "Create a Long-Term Planning (LTP) scenario using MS31 for simulation of the annual plan.",
        whatToDoAR: "أنشئ سيناريو التخطيط طويل الأمد (LTP) باستخدام MS31 لمحاكاة الخطة السنوية.",
        whatSAPDoesEN: "SAP creates the LTP scenario for simulation runs.",
        whatSAPDoesAR: "ينشئ SAP سيناريو LTP لتشغيل المحاكاة.",
        expectedOutputEN: "LTP scenario created.",
        expectedOutputAR: "سيناريو LTP منشأ.",
      },
      {
        id: "pp-budget-s6",
        stepNumber: 6,
        titleEN: "Run MRP for LTP Scenario",
        titleAR: "تشغيل MRP لسيناريو LTP",
        tCode: "MS01",
        role: "Production Planner",
        whatToDoEN: "Run MS01 to execute MRP within the LTP scenario and generate simulated planned orders.",
        whatToDoAR: "شغّل MS01 لتنفيذ MRP ضمن سيناريو LTP وإنشاء أوامر مخططة محاكاة.",
        whatSAPDoesEN: "SAP runs the simulated MRP and creates planned orders within the LTP scenario.",
        whatSAPDoesAR: "يشغّل SAP MRP المحاكى وينشئ أوامر مخططة ضمن سيناريو LTP.",
        expectedOutputEN: "Simulated planned orders generated.",
        expectedOutputAR: "أوامر مخططة محاكاة منشأة.",
      },
      {
        id: "pp-budget-s7",
        stepNumber: 7,
        titleEN: "Evaluate LTP Results",
        titleAR: "تقييم نتائج LTP",
        tCode: "MS06",
        role: "Production Planner",
        whatToDoEN: "Use MS06 (Collective MRP List) to evaluate the LTP scenario results and identify capacity needs.",
        whatToDoAR: "استخدم MS06 (قائمة MRP الجماعية) لتقييم نتائج سيناريو LTP وتحديد احتياجات الطاقة.",
        whatSAPDoesEN: "SAP displays the collective MRP evaluation for the LTP scenario.",
        whatSAPDoesAR: "يعرض SAP تقييم MRP الجماعي لسيناريو LTP.",
        expectedOutputEN: "LTP results evaluated; capacity gaps identified.",
        expectedOutputAR: "نتائج LTP مقيّمة وفجوات الطاقة محدّدة.",
      },
      {
        id: "pp-budget-s8",
        stepNumber: 8,
        titleEN: "Run Capacity Requirement Report",
        titleAR: "تشغيل تقرير متطلبات الطاقة",
        tCode: "CM38",
        role: "Production Planner",
        whatToDoEN: "Run CM38 to produce the capacity requirements report for the budget year.",
        whatToDoAR: "شغّل CM38 لإنتاج تقرير متطلبات الطاقة لسنة الميزانية.",
        whatSAPDoesEN: "SAP generates the capacity requirements report based on the LTP simulation.",
        whatSAPDoesAR: "ينشئ SAP تقرير متطلبات الطاقة بناءً على محاكاة LTP.",
        expectedOutputEN: "Capacity requirements report generated for budget planning.",
        expectedOutputAR: "تقرير متطلبات الطاقة منشأ لتخطيط الميزانية.",
      },
    ],
  },

  // ── PP-040: Further Processing Fresh Daily Planning ───────────────────────
  {
    id: "pp-fp-fresh-daily-planning",
    icon: "🍗",
    duration: "1–2 hours",
    titleEN: "Further Processing Fresh Daily Planning (MTO)",
    titleAR: "تخطيط المعالجة الإضافية للمنتجات الطازجة اليومي (MTO)",
    descriptionEN: "Daily planning for further processing of fresh poultry products: create STOs from branches, create sales orders for distributors, run MPS, and check planned orders.",
    descriptionAR: "التخطيط اليومي لمعالجة الدواجن الطازجة: إنشاء أوامر نقل المخزون من الفروع وأوامر المبيعات للموزعين وتشغيل MPS والتحقق من الأوامر المخططة.",
    module: "PP",
    roles: ["FP Production Planner"],
    steps: [
      {
        id: "pp-fp-s1",
        stepNumber: 1,
        titleEN: "Create STO from Branches to FP Plant",
        titleAR: "إنشاء STO من الفروع إلى مصنع المعالجة الإضافية",
        tCode: "ME21N",
        role: "FP Production Planner",
        whatToDoEN: "Create one STO per branch per day from branches to the Further Processing (FP) plant (1050) to cover planned demand.",
        whatToDoAR: "أنشئ STO واحداً لكل فرع يومياً من الفروع إلى مصنع المعالجة الإضافية (1050) لتغطية الطلب المخطط.",
        whatSAPDoesEN: "SAP creates the inter-plant stock transfer order for branch supply.",
        whatSAPDoesAR: "ينشئ SAP أمر نقل المخزون بين المصانع لتوريد الفروع.",
        expectedOutputEN: "STOs created for all branches.",
        expectedOutputAR: "STOs منشأة لجميع الفروع.",
      },
      {
        id: "pp-fp-s2",
        stepNumber: 2,
        titleEN: "Create Sales Orders for Distributors",
        titleAR: "إنشاء أوامر مبيعات للموزعين",
        tCode: "VA01",
        role: "FP Production Planner",
        whatToDoEN: "Create sales orders for distributors in VA01 based on daily demand forecasts.",
        whatToDoAR: "أنشئ أوامر مبيعات للموزعين في VA01 بناءً على توقعات الطلب اليومي.",
        whatSAPDoesEN: "SAP creates sales orders and generates demand requirements for MPS.",
        whatSAPDoesAR: "ينشئ SAP أوامر مبيعات ويولّد متطلبات الطلب لـ MPS.",
        expectedOutputEN: "Sales orders created for distributors.",
        expectedOutputAR: "أوامر المبيعات منشأة للموزعين.",
      },
      {
        id: "pp-fp-s3",
        stepNumber: 3,
        titleEN: "Check Old Requirements",
        titleAR: "التحقق من المتطلبات القديمة",
        tCode: "MD04",
        role: "FP Production Planner",
        whatToDoEN: "Run MD04 to check that all old requirements are closed before running MPS.",
        whatToDoAR: "شغّل MD04 للتحقق من إغلاق جميع المتطلبات القديمة قبل تشغيل MPS.",
        whatSAPDoesEN: "SAP displays the stock/requirements list for review.",
        whatSAPDoesAR: "يعرض SAP قائمة المخزون والمتطلبات للمراجعة.",
        expectedOutputEN: "Old requirements confirmed closed.",
        expectedOutputAR: "المتطلبات القديمة مؤكدة الإغلاق.",
      },
      {
        id: "pp-fp-s4",
        stepNumber: 4,
        ...
        tCode: "MD01N",
        role: "FP Production Planner",
        whatToDoEN: "Run MD01N to execute Master Production Scheduling for the FP plant and generate planned orders.",
        whatToDoAR: "شغّل MD01N لتنفيذ جدولة الإنتاج الرئيسية لمصنع المعالجة الإضافية وإنشاء الأوامر المخططة.",
        whatSAPDoesEN: "SAP runs MPS and creates approximately 110 planned orders per day for the FP plant.",
        whatSAPDoesAR: "يشغّل SAP MPS وينشئ حوالي 110 أوامر مخططة يومياً لمصنع المعالجة الإضافية.",
        expectedOutputEN: "Planned orders generated (~110/day) for FP plant 1050.",
        expectedOutputAR: "الأوامر المخططة منشأة (~110/يوم) لمصنع المعالجة الإضافية 1050.",
      },
      {
        id: "pp-fp-s5",
        stepNumber: 5,
        titleEN: "Check Stock Requirement List",
        titleAR: "التحقق من قائمة متطلبات المخزون",
        tCode: "MD04/COOIS",
        role: "FP Production Planner",
        whatToDoEN: "Use MD04 and COOIS to verify the MPS results and confirm planned orders are correctly generated.",
        whatToDoAR: "استخدم MD04 وCOOIS للتحقق من نتائج MPS وتأكيد إنشاء الأوامر المخططة بشكل صحيح.",
        whatSAPDoesEN: "SAP displays planned orders and coverage for review.",
        whatSAPDoesAR: "يعرض SAP الأوامر المخططة والتغطية للمراجعة.",
        expectedOutputEN: "MPS results verified; daily plan confirmed.",
        expectedOutputAR: "نتائج MPS محققة؛ الخطة اليومية مؤكدة.",
      },
    ],
  },
  ...
  {
    id: "pp-birds-catching-receiving",
    icon: "🐔",
    duration: "2–4 hours",
    titleEN: "Processing Birds Catching & Receiving",
    titleAR: "مسك واستلام الطيور في مصنع المعالجة",
    descriptionEN: "Manual catching and receiving of broiler birds at the slaughter house: count live/DoA/culls, do truck weighing, and post goods receipt in SAP via MIGO.",
    descriptionAR: "مسك واستلام طيور الدجاج اللاحم يدوياً في المسلخ: عدّ الأحياء والنافقة والمستبعدة ووزن الشاحنات وترحيل استلام البضائع في SAP عبر MIGO.",
    module: "PP",
    roles: ["Slaughter House Supervisor", "Production Planner"],
    steps: [
      {
        id: "pp-birds-s1",
        stepNumber: 1,
        titleEN: "Manual Catching & Receiving at Slaughter House",
        titleAR: "المسك والاستلام اليدوي في المسلخ",
        role: "Slaughter House Supervisor",
        whatToDoEN: "Physically catch and receive broiler birds from farms into the slaughter house. Record all bird counts (Live, DoA, Culls, Rejects) manually on paper before SAP entry.",
        whatToDoAR: "مسك واستلام طيور الدجاج اللاحم يدوياً من المزارع إلى المسلخ. تسجيل جميع أعداد الطيور (أحياء، نافقة، مستبعدة، مرفوضة) يدوياً على الورق قبل الإدخال في SAP.",
        whatSAPDoesEN: "No SAP action at this step — manual counting and receiving.",
        whatSAPDoesAR: "لا يوجد إجراء SAP في هذه الخطوة — عدّ واستلام يدوي.",
        expectedOutputEN: "Bird counts recorded for all categories.",
        expectedOutputAR: "أعداد الطيور مسجّلة لجميع الفئات.",
      },
      {
        id: "pp-birds-s2",
        stepNumber: 2,
        titleEN: "Manual Truck Weighing",
        titleAR: "وزن الشاحنات يدوياً",
        role: "Slaughter House Supervisor",
        whatToDoEN: "Weigh trucks before and after unloading to calculate the net bird weight delivered.",
        whatToDoAR: "وزن الشاحنات قبل وبعد التفريغ لحساب صافي وزن الطيور المسلّمة.",
        whatSAPDoesEN: "No SAP action — manual weighbridge recording.",
        whatSAPDoesAR: "لا يوجد إجراء SAP — تسجيل يدوي على ميزان الشاحنات.",
        expectedOutputEN: "Truck weights (before/after) recorded.",
        expectedOutputAR: "أوزان الشاحنات (قبل/بعد) مسجّلة.",
      },
      {
        id: "pp-birds-s3",
        stepNumber: 3,
        titleEN: "Post Goods Receipt of Broiler",
        titleAR: "ترحيل استلام البضائع للدجاج اللاحم",
        tCode: "MIGO_GR",
        role: "Production Planner",
        whatToDoEN: "Post GR using MIGO_GR with Movement Type 101 to receive broiler birds into the slaughter line storage location in plant 1100.",
        whatToDoAR: "رحّل استلام البضائع باستخدام MIGO_GR ونوع الحركة 101 لاستلام طيور الدجاج اللاحم إلى موقع تخزين خط المسلخ في المصنع 1100.",
        whatSAPDoesEN: "SAP posts the GR and updates inventory in the slaughter line storage location.",
        whatSAPDoesAR: "يرحّل SAP استلام البضائع ويحدّث المخزون في موقع تخزين خط المسلخ.",
        expectedOutputEN: "GR posted; broiler inventory updated in plant 1100.",
        expectedOutputAR: "استلام البضائع مرحّل؛ مخزون الدجاج اللاحم محدّث في المصنع 1100.",
      },
      {
        id: "pp-birds-s4",
        stepNumber: 4,
        titleEN: "Enter Truck Batch Data in Batch Characteristics",
        titleAR: "إدخال بيانات دفعة الشاحنة في خصائص الدفعة",
        tCode: "MSC2N/BMBC",
        role: "Production Planner",
        whatToDoEN: "Use MSC2N or BMBC to enter truck batch data (weights, bird counts) in batch characteristics for traceability.",
        whatToDoAR: "استخدم MSC2N أو BMBC لإدخال بيانات دفعة الشاحنة (الأوزان وأعداد الطيور) في خصائص الدفعة للتتبع.",
        whatSAPDoesEN: "SAP records batch characteristics for the received lot enabling full traceability.",
        whatSAPDoesAR: "يسجّل SAP خصائص الدفعة للدفعة المستلمة مما يتيح التتبع الكامل.",
        expectedOutputEN: "Batch characteristics recorded; ~161 confirmations/day processed.",
        expectedOutputAR: "خصائص الدفعة مسجّلة؛ ~161 تأكيداً يومياً تمت معالجتها.",
      },
    ],
  },
  ...
  {
    id: "pp-broiler-cycle-planning",
    icon: "🐣",
    duration: "4–8 hours",
    titleEN: "Broiler Cycle Planning",
    titleAR: "تخطيط دورة الدجاج اللاحم",
    descriptionEN: "Plan the broiler production cycle every 45 days: check MRP results, run MPS, convert planned orders to production orders (type YPP1), assign houses and WBS, and release orders.",
    descriptionAR: "تخطيط دورة إنتاج الدجاج اللاحم كل 45 يوماً: التحقق من نتائج MRP وتشغيل MPS وتحويل الأوامر المخططة إلى أوامر إنتاج (نوع YPP1) وتعيين المزارع وعناصر WBS وإصدار الأوامر.",
    module: "PP",
    roles: ["Production Planner", "MRP Controller"],
    steps: [
      {
        id: "pp-bcp-s1",
        stepNumber: 1,
        titleEN: "Check Old Requirements & Receipts",
        titleAR: "التحقق من المتطلبات والإيصالات القديمة",
        tCode: "MD04",
        role: "Production Planner",
        whatToDoEN: "Run MD04 to review and close any old requirements or receipts before starting the new cycle plan.",
        whatToDoAR: "شغّل MD04 لمراجعة وإغلاق أي متطلبات أو إيصالات قديمة قبل بدء خطة الدورة الجديدة.",
        whatSAPDoesEN: "SAP displays the stock/requirements list for review.",
        whatSAPDoesAR: "يعرض SAP قائمة المخزون والمتطلبات للمراجعة.",
        expectedOutputEN: "Old requirements/receipts reviewed and closed.",
        expectedOutputAR: "المتطلبات والإيصالات القديمة مراجَعة ومغلقة.",
      },
      {
        id: "pp-bcp-s2",
        stepNumber: 2,
        titleEN: "Reorganize Old PIR Requirements",
        titleAR: "إعادة تنظيم متطلبات PIR القديمة",
        tCode: "MD74",
        role: "Production Planner",
        whatToDoEN: "Run MD74 to clean up and reorganize old Planned Independent Requirements.",
        whatToDoAR: "شغّل MD74 لتنظيف وإعادة تنظيم المتطلبات المستقلة المخططة القديمة.",
        whatSAPDoesEN: "SAP reorganizes and archives old PIRs.",
        whatSAPDoesAR: "يعيد SAP تنظيم وأرشفة PIRs القديمة.",
        expectedOutputEN: "Old PIRs reorganized.",
        expectedOutputAR: "PIRs القديمة معاد تنظيمها.",
      },
      {
        id: "pp-bcp-s3",
        stepNumber: 3,
        titleEN: "Run MPS with Quota Arrangements",
        titleAR: "تشغيل MPS مع ترتيبات الحصص",
        tCode: "MD40",
        role: "MRP Controller",
        whatToDoEN: "Run MD40 to execute Master Production Scheduling considering quota arrangements for house allocation.",
        whatToDoAR: "شغّل MD40 لتنفيذ جدولة الإنتاج الرئيسية مع مراعاة ترتيبات الحصص لتخصيص المزارع.",
        whatSAPDoesEN: "SAP runs MPS and creates planned orders based on quota arrangements.",
        whatSAPDoesAR: "يشغّل SAP MPS وينشئ أوامر مخططة بناءً على ترتيبات الحصص.",
        expectedOutputEN: "MPS run complete; planned orders created.",
        expectedOutputAR: "MPS مكتمل؛ الأوامر المخططة منشأة.",
      },
      {
        id: "pp-bcp-s4",
        stepNumber: 4,
        titleEN: "Evaluate MRP Result",
        titleAR: "تقييم نتيجة MRP",
        tCode: "MD04/COOIS",
        role: "Production Planner",
        whatToDoEN: "Review MRP results using MD04 and COOIS to verify planned order quantities and dates.",
        whatToDoAR: "راجع نتائج MRP باستخدام MD04 وCOOIS للتحقق من كميات وتواريخ الأوامر المخططة.",
        whatSAPDoesEN: "SAP displays planned orders for the cycle.",
        whatSAPDoesAR: "يعرض SAP الأوامر المخططة للدورة.",
        expectedOutputEN: "MRP results evaluated and confirmed.",
        expectedOutputAR: "نتائج MRP مقيّمة ومؤكدة.",
      },
      {
        id: "pp-bcp-s5",
        stepNumber: 5,
        titleEN: "Convert Planned Orders to Production Orders",
        titleAR: "تحويل الأوامر المخططة إلى أوامر إنتاج",
        tCode: "MD04/CO40/CO41/CO01",
        role: "Production Planner",
        whatToDoEN: "Convert planned orders to production orders (type YPP1 – Live Operation) using CO40/CO41 or CO01. Assign house and WBS element to each order.",
        whatToDoAR: "حوّل الأوامر المخططة إلى أوامر إنتاج (نوع YPP1 – التشغيل الفعلي) باستخدام CO40/CO41 أو CO01. عيّن المزرعة وعنصر WBS لكل أمر.",
        whatSAPDoesEN: "SAP converts planned orders to production orders and assigns houses and WBS elements.",
        whatSAPDoesAR: "يحوّل SAP الأوامر المخططة إلى أوامر إنتاج ويعيّن المزارع وعناصر WBS.",
        expectedOutputEN: "~920 production orders created per cycle (YPP1).",
        expectedOutputAR: "~920 أمر إنتاج منشأ لكل دورة (YPP1).",
      },
      {
        id: "pp-bcp-s6",
        stepNumber: 6,
        titleEN: "Release Production Orders",
        titleAR: "إصدار أوامر الإنتاج",
        tCode: "CO02/CO05N",
        role: "Production Planner",
        whatToDoEN: "Release production orders using CO02 (individually) or CO05N (collectively).",
        whatToDoAR: "أصدر أوامر الإنتاج باستخدام CO02 (فردياً) أو CO05N (جماعياً).",
        whatSAPDoesEN: "SAP sets production orders to Released status, enabling execution.",
        whatSAPDoesAR: "يضع SAP أوامر الإنتاج في حالة الإصدار مما يتيح التنفيذ.",
        expectedOutputEN: "All production orders released.",
        expectedOutputAR: "جميع أوامر الإنتاج مُصدَرة.",
      },
      {
        id: "pp-bcp-s7",
        stepNumber: 7,
        titleEN: "Send Cycle Orders to Hatchery",
        titleAR: "إرسال أوامر الدورة إلى المفرخة",
        tCode: "Email/COOIS",
        role: "Production Planner",
        whatToDoEN: "Export and send the production order list (from COOIS) to the hatchery team for DOC planning.",
        whatToDoAR: "صدّر وأرسل قائمة أوامر الإنتاج (من COOIS) إلى فريق المفرخة لتخطيط DOC.",
        whatSAPDoesEN: "COOIS provides the order list for export.",
        whatSAPDoesAR: "يوفر COOIS قائمة الأوامر للتصدير.",
        expectedOutputEN: "Cycle orders communicated to hatchery.",
        expectedOutputAR: "أوامر الدورة مُبلَّغ بها إلى المفرخة.",
      },
    ],
  },

  // ── PP-110: House Preparation ─────────────────────────────────────────────
  {
    id: "pp-house-preparation",
    icon: "🏠",
    duration: "4–8 hours",
    titleEN: "House Preparation",
    titleAR: "تجهيز المزارع",
    descriptionEN: "Prepare broiler houses before each cycle: check preparation plan, request materials via STO (ZZ02), receive and confirm preparation operations, perform TECO, and complete inspection lot usage decision.",
    descriptionAR: "تجهيز مزارع الدجاج اللاحم قبل كل دورة: التحقق من خطة التجهيز وطلب المواد عبر STO (ZZ02) واستلام وتأكيد عمليات التجهيز وتنفيذ TECO وإتمام قرار استخدام فرقة الفحص.",
    module: "PP",
    roles: ["Production Planner", "Farm Supervisor", "PHD Manager"],
    steps: [
      {
        id: "pp-hp-s1",
        stepNumber: 1,
        titleEN: "Check Preparation Plan",
        titleAR: "التحقق من خطة التجهيز",
        tCode: "COOIS/ZPPH3",
        role: "Farm Supervisor",
        whatToDoEN: "Review the preparation plan using COOIS and ZPPH3 to confirm house preparation schedules.",
        whatToDoAR: "راجع خطة التجهيز باستخدام COOIS وZPPH3 لتأكيد جداول تجهيز المزارع.",
        whatSAPDoesEN: "SAP displays the production order list for preparation activities.",
        whatSAPDoesAR: "يعرض SAP قائمة أوامر الإنتاج لأنشطة التجهيز.",
        expectedOutputEN: "Preparation schedule confirmed.",
        expectedOutputAR: "جدول التجهيز مؤكد.",
      },
      {
        id: "pp-hp-s2",
        stepNumber: 2,
        titleEN: "Request Preparation Components via STO",
        titleAR: "طلب مكونات التجهيز عبر STO",
        tCode: "ME21N",
        role: "Farm Supervisor",
        whatToDoEN: "Create a weekly STO (type ZZ02) to request preparation materials from the PHD warehouse to the farm store.",
        whatToDoAR: "أنشئ STO أسبوعياً (نوع ZZ02) لطلب مواد التجهيز من مستودع PHD إلى مخزن المزرعة.",
        whatSAPDoesEN: "SAP creates the STO and generates a release approval workflow.",
        whatSAPDoesAR: "ينشئ SAP STO ويولّد سير عمل موافقة الإصدار.",
        expectedOutputEN: "STO created and submitted for approval.",
        expectedOutputAR: "STO منشأ ومقدَّم للموافقة.",
      },
      {
        id: "pp-hp-s3",
        stepNumber: 3,
        titleEN: "PHD Manager Approval of STO",
        titleAR: "موافقة مدير PHD على STO",
        tCode: "ME29N",
        role: "PHD Manager",
        whatToDoEN: "Approve the STO using ME29N (Release Code P2, Strategy S1) to authorize material transfer.",
        whatToDoAR: "وافق على STO باستخدام ME29N (رمز الإصدار P2، الاستراتيجية S1) للسماح بنقل المواد.",
        whatSAPDoesEN: "SAP releases the STO for goods issue.",
        whatSAPDoesAR: "يُصدر SAP STO لإصدار البضائع.",
        expectedOutputEN: "STO approved and released.",
        expectedOutputAR: "STO موافق عليه ومُصدَر.",
      },
      {
        id: "pp-hp-s4",
        stepNumber: 4,
        titleEN: "Goods Issue to STO",
        titleAR: "إصدار البضائع إلى STO",
        tCode: "MIGO_GI",
        role: "Farm Supervisor",
        whatToDoEN: "Post goods issue using MIGO_GI with Movement Type 351 to transfer materials from PHD warehouse.",
        whatToDoAR: "رحّل إصدار البضائع باستخدام MIGO_GI ونوع الحركة 351 لنقل المواد من مستودع PHD.",
        whatSAPDoesEN: "SAP reduces inventory in PHD warehouse and creates goods in transit.",
        whatSAPDoesAR: "يقلّل SAP المخزون في مستودع PHD وينشئ بضائع في العبور.",
        expectedOutputEN: "GI posted (Mvt 351); materials in transit.",
        expectedOutputAR: "إصدار البضائع مرحّل (نوع 351)؛ المواد في العبور.",
      },
      {
        id: "pp-hp-s5",
        stepNumber: 5,
        titleEN: "Goods Receipt at Farm Store",
        titleAR: "استلام البضائع في مخزن المزرعة",
        tCode: "MIGO_GR",
        role: "Farm Supervisor",
        whatToDoEN: "Post goods receipt at the farm store location using MIGO_GR with Movement Type 101.",
        whatToDoAR: "رحّل استلام البضائع في موقع مخزن المزرعة باستخدام MIGO_GR ونوع الحركة 101.",
        whatSAPDoesEN: "SAP increases inventory at the farm store location.",
        whatSAPDoesAR: "يزيد SAP المخزون في موقع مخزن المزرعة.",
        expectedOutputEN: "GR posted (Mvt 101); materials received at farm.",
        expectedOutputAR: "استلام البضائع مرحّل (نوع 101)؛ المواد مستلمة في المزرعة.",
      },
      {
        id: "pp-hp-s6",
        stepNumber: 6,
        titleEN: "Confirm Preparation Operation",
        titleAR: "تأكيد عملية التجهيز",
        tCode: "CO11N",
        role: "Farm Supervisor",
        whatToDoEN: "Confirm the preparation operation using CO11N — SAP will automatically backflush consumed materials (Mvt 261).",
        whatToDoAR: "أكّد عملية التجهيز باستخدام CO11N — سيقوم SAP تلقائياً بسحب المواد المستهلكة (نوع 261).",
        whatSAPDoesEN: "SAP posts confirmation and backflushes component consumption (Mvt 261).",
        whatSAPDoesAR: "يرحّل SAP التأكيد ويسحب استهلاك المكونات (نوع 261).",
        expectedOutputEN: "Preparation operation confirmed; components backflushed.",
        expectedOutputAR: "عملية التجهيز مؤكدة؛ المكونات مسحوبة.",
      },
      {
        id: "pp-hp-s7",
        stepNumber: 7,
        titleEN: "Final Confirmation & Automatic GR",
        titleAR: "التأكيد النهائي والاستلام التلقائي",
        tCode: "CO11N",
        role: "Farm Supervisor",
        whatToDoEN: "Post final confirmation in CO11N to complete the preparation order and trigger automatic GR.",
        whatToDoAR: "رحّل التأكيد النهائي في CO11N لإتمام أمر التجهيز وتشغيل الاستلام التلقائي.",
        whatSAPDoesEN: "SAP sets the order to DLV status and posts automatic GR.",
        whatSAPDoesAR: "يضع SAP الأمر في حالة DLV ويرحّل الاستلام التلقائي.",
        expectedOutputEN: "Order delivered; automatic GR posted.",
        expectedOutputAR: "الأمر مُسلَّم؛ الاستلام التلقائي مرحّل.",
      },
      {
        id: "pp-hp-s8",
        stepNumber: 8,
        titleEN: "Technically Complete (TECO) Production Order",
        titleAR: "الإغلاق التقني لأمر الإنتاج (TECO)",
        tCode: "CO02",
        role: "Production Planner",
        whatToDoEN: "Set the production order to Technically Complete (TECO) status using CO02.",
        whatToDoAR: "ضع أمر الإنتاج في حالة الإغلاق التقني (TECO) باستخدام CO02.",
        whatSAPDoesEN: "SAP marks the order TECO and clears open reservations.",
        whatSAPDoesAR: "يضع SAP الأمر في وضع TECO ويُغلق الحجوزات المفتوحة.",
        expectedOutputEN: "Production order TECO; ~28 orders/day processed.",
        expectedOutputAR: "أمر الإنتاج في وضع TECO؛ ~28 أمراً/يوم تمت معالجتها.",
      },
      {
        id: "pp-hp-s9",
        stepNumber: 9,
        titleEN: "Usage Decision on Inspection Lot",
        titleAR: "قرار الاستخدام على فرقة الفحص",
        tCode: "QA32",
        role: "Quality Inspector",
        whatToDoEN: "Make the usage decision on the inspection lot created during house preparation in QA32.",
        whatToDoAR: "اتخذ قرار الاستخدام على فرقة الفحص المنشأة أثناء تجهيز المزرعة في QA32.",
        whatSAPDoesEN: "SAP records the QM usage decision and releases the inspection lot.",
        whatSAPDoesAR: "يسجّل SAP قرار استخدام QM ويُصدر فرقة الفحص.",
        expectedOutputEN: "Inspection lot usage decision made; house preparation complete.",
        expectedOutputAR: "قرار استخدام فرقة الفحص متخذ؛ تجهيز المزرعة مكتمل.",
      },
    ],
  },
  ...
  {
    id: "pp-broiler-growing",
    icon: "🐓",
    duration: "Daily (cycle ~45 days)",
    titleEN: "Broiler Growing",
    titleAR: "تربية الدجاج اللاحم",
    descriptionEN: "Daily execution of broiler growing cycle: receive DOC chicks, adjust production order quantities and operations, record daily QM data and mortality, confirm daily activities, and close the cycle on catching day.",
    descriptionAR: "التنفيذ اليومي لدورة تربية الدجاج اللاحم: استلام كتاكيت DOC وضبط كميات وعمليات أمر الإنتاج وتسجيل بيانات QM اليومية والنفوق وتأكيد الأنشطة اليومية وإغلاق الدورة في يوم المسك.",
    module: "PP",
    roles: ["Production Planner", "Farm Supervisor", "Quality Inspector"],
    steps: [
      {
        id: "pp-bg-s1",
        stepNumber: 1,
        titleEN: "Check Placement Plan",
        titleAR: "التحقق من خطة التوضيع",
        tCode: "COOIS",
        role: "Production Planner",
        whatToDoEN: "Check the placement plan in COOIS to confirm DOC arrival schedule and house assignments.",
        whatToDoAR: "تحقق من خطة التوضيع في COOIS لتأكيد جدول وصول DOC وتعيينات المزارع.",
        whatSAPDoesEN: "SAP displays production orders with planned dates and locations.",
        whatSAPDoesAR: "يعرض SAP أوامر الإنتاج مع التواريخ والمواقع المخططة.",
        expectedOutputEN: "Placement plan confirmed.",
        expectedOutputAR: "خطة التوضيع مؤكدة.",
      },
      {
        id: "pp-bg-s2",
        stepNumber: 2,
        titleEN: "GR of DOC Chicks at House",
        titleAR: "استلام كتاكيت DOC في المزرعة",
        tCode: "MIGO_GR",
        role: "Farm Supervisor",
        whatToDoEN: "Post goods receipt for DOC chicks in the house storage location using Movement Type 101.",
        whatToDoAR: "رحّل استلام البضائع لكتاكيت DOC في موقع تخزين المزرعة باستخدام نوع الحركة 101.",
        whatSAPDoesEN: "SAP posts the GR and updates DOC inventory at house location.",
        whatSAPDoesAR: "يرحّل SAP استلام البضائع ويحدّث مخزون DOC في موقع المزرعة.",
        expectedOutputEN: "DOC chicks received in house storage.",
        expectedOutputAR: "كتاكيت DOC مستلمة في مخزن المزرعة.",
      },
      {
        id: "pp-bg-s3",
        stepNumber: 3,
        titleEN: "Adjust Order Quantities & Dates",
        titleAR: "ضبط كميات وتواريخ الأمر",
        tCode: "CO02",
        role: "Production Planner",
        whatToDoEN: "Adjust the target quantity and dates in CO02 to reflect actual DOC received.",
        whatToDoAR: "اضبط الكمية المستهدفة والتواريخ في CO02 لتعكس الكمية الفعلية المستلمة من DOC.",
        whatSAPDoesEN: "SAP updates the production order header with revised quantities and dates.",
        whatSAPDoesAR: "يحدّث SAP رأس أمر الإنتاج بالكميات والتواريخ المعدّلة.",
        expectedOutputEN: "Order target quantity and dates updated.",
        expectedOutputAR: "الكمية المستهدفة وتواريخ الأمر محدّثة.",
      },
      {
        id: "pp-bg-s4",
        stepNumber: 4,
        titleEN: "Daily QM Recording",
        titleAR: "تسجيل QM اليومي",
        tCode: "QA32/ZPPH3",
        role: "Farm Supervisor",
        whatToDoEN: "Record daily QM data (DoA, Culls, Mortality) using QA32 or the ZPPH3 custom transaction.",
        whatToDoAR: "سجّل بيانات QM اليومية (النافقة عند الوصول، المستبعدات، النفوق) باستخدام QA32 أو معاملة ZPPH3 المخصصة.",
        whatSAPDoesEN: "SAP records inspection lot results for the production order.",
        whatSAPDoesAR: "يسجّل SAP نتائج فرقة الفحص لأمر الإنتاج.",
        expectedOutputEN: "Daily mortality and cull data recorded.",
        expectedOutputAR: "بيانات النفوق اليومية والمستبعدات مسجّلة.",
      },
      {
        id: "pp-bg-s5",
        stepNumber: 5,
        titleEN: "Daily Confirmations",
        titleAR: "التأكيدات اليومية",
        tCode: "CO11N",
        role: "Farm Supervisor",
        whatToDoEN: "Post daily confirmations in CO11N with backflush of feed and other consumed materials (Mvt 261).",
        whatToDoAR: "رحّل التأكيدات اليومية في CO11N مع السحب التلقائي للعلف والمواد المستهلكة الأخرى (نوع 261).",
        whatSAPDoesEN: "SAP posts activity confirmations and backflushes component consumption.",
        whatSAPDoesAR: "يرحّل SAP تأكيدات الأنشطة ويسحب استهلاك المكونات.",
        expectedOutputEN: "Daily activities confirmed; components backflushed.",
        expectedOutputAR: "الأنشطة اليومية مؤكدة؛ المكونات مسحوبة.",
      },
      {
        id: "pp-bg-s6",
        stepNumber: 6,
        titleEN: "Production Order TECO",
        titleAR: "الإغلاق التقني لأمر الإنتاج",
        tCode: "CO02",
        role: "Production Planner",
        whatToDoEN: "Set the production order to TECO after catching is complete.",
        whatToDoAR: "ضع أمر الإنتاج في حالة TECO بعد اكتمال عملية المسك.",
        whatSAPDoesEN: "SAP closes the production order and clears open reservations.",
        whatSAPDoesAR: "يغلق SAP أمر الإنتاج ويُغلق الحجوزات المفتوحة.",
        expectedOutputEN: "Production order TECO; ~980 orders/cycle processed.",
        expectedOutputAR: "أمر الإنتاج في وضع TECO؛ ~980 أمراً/دورة تمت معالجتها.",
      },
      {
        id: "pp-bg-s7",
        stepNumber: 7,
        titleEN: "Inspection Lot Usage Decision",
        titleAR: "قرار استخدام فرقة الفحص",
        tCode: "QA32",
        role: "Quality Inspector",
        whatToDoEN: "Make the final usage decision on the inspection lot for the completed broiler cycle.",
        whatToDoAR: "اتخذ قرار الاستخدام النهائي على فرقة الفحص لدورة الدجاج اللاحم المكتملة.",
        whatSAPDoesEN: "SAP records the final QM decision and closes the inspection lot.",
        whatSAPDoesAR: "يسجّل SAP قرار QM النهائي ويغلق فرقة الفحص.",
        expectedOutputEN: "Inspection lot closed; broiler cycle complete.",
        expectedOutputAR: "فرقة الفحص مغلقة؛ دورة الدجاج اللاحم مكتملة.",
      },
    ],
  },

  // ── PP-130: Vaccination & Medication & Lab ────────────────────────────────
  {
    id: "pp-vaccination-medication-lab",
    icon: "💉",
    duration: "Daily",
    titleEN: "Vaccination, Medication & Lab",
    titleAR: "التطعيم والدواء والمختبر",
    descriptionEN: "Daily vaccination, medication supply, and lab testing for broiler farms: request supplies via STO (ZZ02), receive materials, record lab results, and confirm vaccination operations.",
    descriptionAR: "التطعيم اليومي وتوريد الدواء والاختبارات المختبرية لمزارع الدجاج اللاحم: طلب المستلزمات عبر STO (ZZ02) واستلام المواد وتسجيل نتائج المختبر وتأكيد عمليات التطعيم.",
    module: "PP",
    roles: ["Farm Supervisor", "Veterinarian", "PHD Manager", "Quality Inspector"],
    steps: [
      {
        id: "pp-vac-s1",
        stepNumber: 1,
        titleEN: "Check Vaccination & Medication Plan",
        titleAR: "التحقق من خطة التطعيم والدواء",
        tCode: "COOIS/ZPPH3",
        role: "Veterinarian",
        whatToDoEN: "Review the vaccination and medication plan for the day using COOIS and ZPPH3.",
        whatToDoAR: "راجع خطة التطعيم والدواء لليوم باستخدام COOIS وZPPH3.",
        whatSAPDoesEN: "SAP displays planned vaccination and medication operations.",
        whatSAPDoesAR: "يعرض SAP عمليات التطعيم والدواء المخططة.",
        expectedOutputEN: "Daily vaccination/medication schedule confirmed.",
        expectedOutputAR: "جدول التطعيم/الدواء اليومي مؤكد.",
      },
      {
        id: "pp-vac-s2",
        stepNumber: 2,
        titleEN: "Request Vaccination & Medication via STO",
        titleAR: "طلب التطعيم والدواء عبر STO",
        tCode: "ME21N",
        role: "Farm Supervisor",
        whatToDoEN: "Create a daily STO (type ZZ02, one per farm) to request vaccination and medication items from PHD warehouse.",
        whatToDoAR: "أنشئ STO يومياً (نوع ZZ02، واحد لكل مزرعة) لطلب مواد التطعيم والدواء من مستودع PHD.",
        whatSAPDoesEN: "SAP creates the STO and routes for PHD Manager approval.",
        whatSAPDoesAR: "ينشئ SAP STO ويوجهه لموافقة مدير PHD.",
        expectedOutputEN: "STO created for vaccination/medication supply.",
        expectedOutputAR: "STO منشأ لتوريد التطعيم/الدواء.",
      },
      {
        id: "pp-vac-s3",
        stepNumber: 3,
        titleEN: "PHD Manager Approval",
        titleAR: "موافقة مدير PHD",
        tCode: "ME29N",
        role: "PHD Manager",
        whatToDoEN: "Approve the daily vaccination/medication STO using ME29N.",
        whatToDoAR: "وافق على STO التطعيم/الدواء اليومي باستخدام ME29N.",
        whatSAPDoesEN: "SAP releases the STO for goods issue.",
        whatSAPDoesAR: "يُصدر SAP STO لإصدار البضائع.",
        expectedOutputEN: "STO approved by PHD Manager.",
        expectedOutputAR: "STO موافق عليه من مدير PHD.",
      },
      {
        id: "pp-vac-s4",
        stepNumber: 4,
        titleEN: "Goods Issue from PHD Warehouse",
        titleAR: "إصدار البضائع من مستودع PHD",
        tCode: "MIGO_GI",
        role: "PHD Warehouse",
        whatToDoEN: "Post goods issue (Mvt 351) to transfer vaccination/medication from PHD warehouse.",
        whatToDoAR: "رحّل إصدار البضائع (نوع 351) لنقل التطعيم/الدواء من مستودع PHD.",
        whatSAPDoesEN: "SAP reduces PHD warehouse inventory.",
        whatSAPDoesAR: "يقلّل SAP مخزون مستودع PHD.",
        expectedOutputEN: "GI posted (Mvt 351).",
        expectedOutputAR: "إصدار البضائع مرحّل (نوع 351).",
      },
      {
        id: "pp-vac-s5",
        stepNumber: 5,
        ...
        tCode: "MIGO_GR",
        role: "Farm Supervisor",
        whatToDoEN: "Post goods receipt (Mvt 101) at the farm store location for vaccination and medication items.",
        whatToDoAR: "رحّل استلام البضائع (نوع 101) في موقع مخزن المزرعة لمواد التطعيم والدواء.",
        whatSAPDoesEN: "SAP increases farm store inventory.",
        whatSAPDoesAR: "يزيد SAP مخزون مخزن المزرعة.",
        expectedOutputEN: "Vaccination/medication received at farm.",
        expectedOutputAR: "مواد التطعيم/الدواء مستلمة في المزرعة.",
      },
      {
        id: "pp-vac-s6",
        stepNumber: 6,
        titleEN: "Record Lab Results",
        titleAR: "تسجيل نتائج المختبر",
        tCode: "QA32/ZPPH3/QE01",
        role: "Quality Inspector",
        whatToDoEN: "Record lab results in QA32, ZPPH3, or QE01 for serum bank and field tests.",
        whatToDoAR: "سجّل نتائج المختبر في QA32 أو ZPPH3 أو QE01 لاختبارات بنك المصل والحقل.",
        whatSAPDoesEN: "SAP records inspection results against the inspection lot.",
        whatSAPDoesAR: "يسجّل SAP نتائج الفحص مقابل فرقة الفحص.",
        expectedOutputEN: "Lab results recorded in SAP.",
        expectedOutputAR: "نتائج المختبر مسجّلة في SAP.",
      },
      {
        id: "pp-vac-s7",
        stepNumber: 7,
        titleEN: "Confirm Vaccination Operations",
        titleAR: "تأكيد عمليات التطعيم",
        tCode: "CO11N",
        role: "Farm Supervisor",
        whatToDoEN: "Confirm vaccination operations in CO11N — SAP backflushes vaccine and medication consumption (Mvt 261).",
        whatToDoAR: "أكّد عمليات التطعيم في CO11N — يسحب SAP تلقائياً استهلاك اللقاحات والأدوية (نوع 261).",
        whatSAPDoesEN: "SAP confirms the operation and backflushes consumed vaccines and medications.",
        whatSAPDoesAR: "يؤكد SAP العملية ويسحب اللقاحات والأدوية المستهلكة.",
        expectedOutputEN: "Vaccination operations confirmed; consumption posted.",
        expectedOutputAR: "عمليات التطعيم مؤكدة؛ الاستهلاك مرحّل.",
      },
    ],
  },

  // ── PP-170: Surplus Hatching Eggs Packing ────────────────────────────────
  {
    id: "pp-surplus-eggs-packing",
    icon: "🥚",
    duration: "Daily",
    titleEN: "Surplus Hatching Eggs Packing",
    titleAR: "تعبئة بيض التفريخ الفائض",
    descriptionEN: "Pack and transfer surplus hatching eggs: request packing materials via STO, perform REM collective confirmation for packed eggs, transfer to finished store, and adjust unpacked egg prices monthly.",
    descriptionAR: "تعبئة ونقل بيض التفريخ الفائض: طلب مواد التعبئة عبر STO وتنفيذ تأكيد REM الجماعي للبيض المعبأ ونقله إلى مخزن المنتجات النهائية وتعديل أسعار البيض غير المعبأ شهرياً.",
    module: "PP",
    roles: ["Hatchery Supervisor", "Production Planner"],
    steps: [
      {
        id: "pp-sep-s1",
        stepNumber: 1,
        titleEN: "Create Packing STO",
        titleAR: "إنشاء STO التعبئة",
        tCode: "ME21N",
        role: "Hatchery Supervisor",
        whatToDoEN: "Create a weekly STO for packing materials from the layer packing store to the hatchery.",
        whatToDoAR: "أنشئ STO أسبوعياً لمواد التعبئة من مخزن تعبئة القاطع إلى المفرخة.",
        whatSAPDoesEN: "SAP creates the packing material STO.",
        whatSAPDoesAR: "ينشئ SAP STO مواد التعبئة.",
        expectedOutputEN: "Packing STO created.",
        expectedOutputAR: "STO التعبئة منشأ.",
      },
      {
        id: "pp-sep-s2",
        stepNumber: 2,
        titleEN: "Goods Issue to Packing STO",
        titleAR: "إصدار البضائع إلى STO التعبئة",
        tCode: "MIGO_GI",
        role: "Hatchery Supervisor",
        whatToDoEN: "Post goods issue (Mvt 351) to transfer packing materials.",
        whatToDoAR: "رحّل إصدار البضائع (نوع 351) لنقل مواد التعبئة.",
        whatSAPDoesEN: "SAP reduces inventory at source storage location.",
        whatSAPDoesAR: "يقلّل SAP المخزون في موقع التخزين المصدر.",
        expectedOutputEN: "GI posted (Mvt 351).",
        expectedOutputAR: "إصدار البضائع مرحّل (نوع 351).",
      },
      {
        id: "pp-sep-s3",
        stepNumber: 3,
        titleEN: "Goods Receipt from Packing STO",
        titleAR: "استلام البضائع من STO التعبئة",
        tCode: "MIGO_GR",
        role: "Hatchery Supervisor",
        whatToDoEN: "Post goods receipt (Mvt 101) at the hatchery packing area.",
        whatToDoAR: "رحّل استلام البضائع (نوع 101) في منطقة تعبئة المفرخة.",
        whatSAPDoesEN: "SAP increases packing material inventory at the hatchery.",
        whatSAPDoesAR: "يزيد SAP مخزون مواد التعبئة في المفرخة.",
        expectedOutputEN: "Packing materials received at hatchery.",
        expectedOutputAR: "مواد التعبئة مستلمة في المفرخة.",
      },
      {
        id: "pp-sep-s4",
        stepNumber: 4,
        titleEN: "Collective REM Confirmation for Packed Eggs",
        titleAR: "تأكيد REM الجماعي للبيض المعبأ",
        tCode: "MF42N",
        role: "Production Planner",
        whatToDoEN: "Run MF42N daily to post collective REM confirmation for finished (packed) hatching eggs as GR.",
        whatToDoAR: "شغّل MF42N يومياً لترحيل تأكيد REM الجماعي للبيض (المعبأ) كاستلام منتجات نهائية.",
        whatSAPDoesEN: "SAP posts GR for packed eggs and backflushes consumed packing materials.",
        whatSAPDoesAR: "يرحّل SAP استلام البيض المعبأ ويسحب مواد التعبئة المستهلكة.",
        expectedOutputEN: "~18 REM confirmations/day posted; packed eggs received.",
        expectedOutputAR: "~18 تأكيد REM يومياً مرحّل؛ البيض المعبأ مستلَم.",
      },
      {
        id: "pp-sep-s5",
        stepNumber: 5,
        titleEN: "Transfer Packed Eggs to Finished Store",
        titleAR: "نقل البيض المعبأ إلى مخزن المنتجات النهائية",
        tCode: "ME21N",
        role: "Production Planner",
        whatToDoEN: "Create a daily STO to transfer packed eggs to the finished product store.",
        whatToDoAR: "أنشئ STO يومياً لنقل البيض المعبأ إلى مخزن المنتجات النهائية.",
        whatSAPDoesEN: "SAP creates the transfer STO.",
        whatSAPDoesAR: "ينشئ SAP STO النقل.",
        expectedOutputEN: "Transfer STO created.",
        expectedOutputAR: "STO النقل منشأ.",
      },
      {
        id: "pp-sep-s6",
        stepNumber: 6,
        titleEN: "GI & GR for Transfer to Finished Store",
        titleAR: "إصدار واستلام البضائع للنقل إلى المخزن النهائي",
        tCode: "MIGO_GI/MIGO_GR",
        role: "Hatchery Supervisor",
        whatToDoEN: "Post GI (Mvt 351) and GR (Mvt 101) to complete the transfer of packed eggs to finished product store.",
        whatToDoAR: "رحّل إصدار البضائع (نوع 351) واستلام البضائع (نوع 101) لإتمام نقل البيض المعبأ إلى مخزن المنتجات النهائية.",
        whatSAPDoesEN: "SAP updates inventory in both source and destination locations.",
        whatSAPDoesAR: "يحدّث SAP المخزون في موقعي المصدر والوجهة.",
        expectedOutputEN: "Packed eggs transferred to finished store.",
        expectedOutputAR: "البيض المعبأ منقول إلى المخزن النهائي.",
      },
      {
        id: "pp-sep-s7",
        stepNumber: 7,
        titleEN: "Monthly: Unpacked Egg Price Change",
        titleAR: "شهرياً: تغيير سعر البيض غير المعبأ",
        tCode: "MR21",
        role: "Production Planner",
        whatToDoEN: "Run MR21 monthly to adjust the price of unpacked (surplus) eggs.",
        whatToDoAR: "شغّل MR21 شهرياً لتعديل سعر البيض غير المعبأ (الفائض).",
        whatSAPDoesEN: "SAP revalues unpacked egg inventory at the new price.",
        whatSAPDoesAR: "يعيد SAP تقييم مخزون البيض غير المعبأ بالسعر الجديد.",
        expectedOutputEN: "Unpacked egg price updated; plant 1210 inventory revalued.",
        expectedOutputAR: "سعر البيض غير المعبأ محدّث؛ مخزون المصنع 1210 معاد تقييمه.",
      },
    ],
  },
  ...
  {
    id: "pp-laying-growing-egg-production",
    icon: "🐓",
    duration: "Daily (cycle ~80 weeks)",
    titleEN: "Laying Growing / Egg Production",
    titleAR: "تربية قطيع البياض / إنتاج البيض",
    descriptionEN: "Daily execution of laying hen egg production cycle: adjust production order, record daily QM data, confirm daily activities, post egg GR, and close cycle at end of production life.",
    descriptionAR: "التنفيذ اليومي لدورة إنتاج البيض: ضبط أمر الإنتاج وتسجيل بيانات QM اليومية وتأكيد الأنشطة وترحيل استلام البيض وإغلاق الدورة عند نهاية حياة الإنتاج.",
    module: "PP",
    roles: ["Production Planner", "Farm Supervisor", "Quality Inspector"],
    steps: [
      {
        id: "pp-ley-s1",
        stepNumber: 1,
        titleEN: "Adjust Order Target Egg Qty & Dates",
        titleAR: "ضبط الكمية المستهدفة من البيض والتواريخ",
        tCode: "CO02",
        role: "Production Planner",
        whatToDoEN: "Adjust the target egg quantity and dates in CO02 to align with actual flock performance.",
        whatToDoAR: "اضبط الكمية المستهدفة من البيض والتواريخ في CO02 لتتوافق مع الأداء الفعلي للقطيع.",
        whatSAPDoesEN: "SAP updates the production order header for the layer cycle.",
        whatSAPDoesAR: "يحدّث SAP رأس أمر الإنتاج لدورة البياض.",
        expectedOutputEN: "Egg production targets updated.",
        expectedOutputAR: "أهداف إنتاج البيض محدّثة.",
      },
      {
        id: "pp-ley-s2",
        stepNumber: 2,
        titleEN: "Daily QM Data Recording",
        titleAR: "تسجيل بيانات QM اليومية",
        tCode: "QA32/ZPPH3",
        role: "Farm Supervisor",
        whatToDoEN: "Record daily flock performance data (mortality, culls, feed consumption) using QA32 or ZPPH3.",
        whatToDoAR: "سجّل بيانات أداء القطيع اليومية (النفوق والمستبعدات واستهلاك العلف) باستخدام QA32 أو ZPPH3.",
        whatSAPDoesEN: "SAP records QM results on the inspection lot.",
        whatSAPDoesAR: "يسجّل SAP نتائج QM على فرقة الفحص.",
        expectedOutputEN: "Daily QM data recorded.",
        expectedOutputAR: "بيانات QM اليومية مسجّلة.",
      },
      {
        id: "pp-ley-s3",
        stepNumber: 3,
        ...
        tCode: "CO11N",
        role: "Farm Supervisor",
        whatToDoEN: "Post daily activity confirmations in CO11N with backflush of feed and materials (Mvt 261).",
        whatToDoAR: "رحّل تأكيدات الأنشطة اليومية في CO11N مع السحب التلقائي للعلف والمواد (نوع 261).",
        whatSAPDoesEN: "SAP confirms daily activities and posts component consumption.",
        whatSAPDoesAR: "يؤكد SAP الأنشطة اليومية ويرحّل استهلاك المكونات.",
        expectedOutputEN: "Daily activities confirmed.",
        expectedOutputAR: "الأنشطة اليومية مؤكدة.",
      },
      {
        id: "pp-ley-s4",
        stepNumber: 4,
        titleEN: "Daily Eggs GR",
        titleAR: "استلام البيض اليومي",
        tCode: "MIGO_GO",
        role: "Farm Supervisor",
        whatToDoEN: "Post daily egg goods receipt using MIGO_GO (Mvt 101) to receive collected eggs into inventory.",
        whatToDoAR: "رحّل استلام البيض اليومي باستخدام MIGO_GO (نوع 101) لاستلام البيض المجمّع في المخزون.",
        whatSAPDoesEN: "SAP posts egg GR and updates egg inventory.",
        whatSAPDoesAR: "يرحّل SAP استلام البيض ويحدّث مخزون البيض.",
        expectedOutputEN: "Daily egg GR posted; egg inventory updated.",
        expectedOutputAR: "استلام البيض اليومي مرحّل؛ مخزون البيض محدّث.",
      },
      {
        id: "pp-ley-s5",
        stepNumber: 5,
        ...
        tCode: "CO02",
        role: "Production Planner",
        whatToDoEN: "Set the production order to TECO at end of laying cycle (birds >80 weeks).",
        whatToDoAR: "ضع أمر الإنتاج في حالة TECO في نهاية دورة البياض (الطيور >80 أسبوعاً).",
        whatSAPDoesEN: "SAP closes the production order.",
        whatSAPDoesAR: "يغلق SAP أمر الإنتاج.",
        expectedOutputEN: "Production order TECO; ~380 orders total across plants 1220/1250/3200.",
        expectedOutputAR: "أمر الإنتاج في وضع TECO؛ ~380 أمراً إجمالياً عبر المصانع 1220/1250/3200.",
      },
      {
        id: "pp-ley-s6",
        stepNumber: 6,
        ...
        tCode: "QA32",
        role: "Quality Inspector",
        whatToDoEN: "Make the final usage decision on the inspection lot for the completed laying cycle.",
        whatToDoAR: "اتخذ قرار الاستخدام النهائي على فرقة الفحص لدورة البياض المكتملة.",
        whatSAPDoesEN: "SAP records the final QM usage decision.",
        whatSAPDoesAR: "يسجّل SAP قرار استخدام QM النهائي.",
        expectedOutputEN: "Inspection lot closed; laying cycle complete.",
        expectedOutputAR: "فرقة الفحص مغلقة؛ دورة البياض مكتملة.",
      },
    ],
  },
  ...
  {
    id: "pp-laying-pre-production",
    icon: "🐔",
    duration: "Daily (pre-production phase)",
    titleEN: "Laying Growing / Pre-Production",
    titleAR: "تربية قطيع البياض / مرحلة ما قبل الإنتاج",
    descriptionEN: "Manage the pre-production phase of laying hens: adjust order quantities, confirm daily activities, auto-receive transferred birds, and close the order before egg production begins.",
    descriptionAR: "إدارة مرحلة ما قبل الإنتاج لقطيع البياض: ضبط كميات الأمر وتأكيد الأنشطة اليومية والاستلام التلقائي للطيور المنقولة وإغلاق الأمر قبل بدء إنتاج البيض.",
    module: "PP",
    roles: ["Production Planner", "Farm Supervisor", "Quality Inspector"],
    steps: [
      {
        ...
        tCode: "COOIS",
        role: "Production Planner",
        whatToDoEN: "Review the placement plan in COOIS to confirm pullet transfer schedule.",
        whatToDoAR: "راجع خطة التوضيع في COOIS لتأكيد جدول نقل الدجاجات الصغيرة.",
        whatSAPDoesEN: "SAP displays pre-production orders with planned dates.",
        whatSAPDoesAR: "يعرض SAP أوامر ما قبل الإنتاج مع التواريخ المخططة.",
        expectedOutputEN: "Placement schedule confirmed.",
        expectedOutputAR: "جدول التوضيع مؤكد.",
      },
      {
        id: "pp-lpp-s2",
        stepNumber: 2,
        ...
        tCode: "CO02",
        role: "Production Planner",
        whatToDoEN: "Adjust target quantities and dates in CO02 to reflect actual flock placement.",
        whatToDoAR: "اضبط الكميات المستهدفة والتواريخ في CO02 لتعكس التوضيع الفعلي للقطيع.",
        whatSAPDoesEN: "SAP updates the production order for the pre-production phase.",
        whatSAPDoesAR: "يحدّث SAP أمر الإنتاج لمرحلة ما قبل الإنتاج.",
        expectedOutputEN: "Order quantities and dates adjusted.",
        expectedOutputAR: "كميات وتواريخ الأمر مضبوطة.",
      },
      {
        id: "pp-lpp-s3",
        stepNumber: 3,
        ...
        tCode: "CO11N",
        role: "Farm Supervisor",
        whatToDoEN: "Post daily confirmations in CO11N — issue pullets (Mvt 261) and backflush feed.",
        whatToDoAR: "رحّل التأكيدات اليومية في CO11N — إصدار الدجاجات الصغيرة (نوع 261) والسحب التلقائي للعلف.",
        whatSAPDoesEN: "SAP posts activity confirmation and issues pullets from inventory.",
        whatSAPDoesAR: "يرحّل SAP تأكيد الأنشطة ويصدر الدجاجات الصغيرة من المخزون.",
        expectedOutputEN: "Daily activities confirmed; pullets issued.",
        expectedOutputAR: "الأنشطة اليومية مؤكدة؛ الدجاجات الصغيرة مُصدَرة.",
      },
      {
        id: "pp-lpp-s4",
        stepNumber: 4,
        titleEN: "Auto GR of Pre-Production Birds",
        titleAR: "الاستلام التلقائي لطيور ما قبل الإنتاج",
        tCode: "CO11N",
        role: "Farm Supervisor",
        whatToDoEN: "Post final confirmation to trigger automatic GR of pre-production birds (Mvt 101) into laying inventory.",
        whatToDoAR: "رحّل التأكيد النهائي لتشغيل الاستلام التلقائي لطيور ما قبل الإنتاج (نوع 101) في مخزون البياض.",
        whatSAPDoesEN: "SAP automatically posts GR for birds transitioning to laying phase.",
        whatSAPDoesAR: "يرحّل SAP تلقائياً استلام الطيور المنتقلة إلى مرحلة البياض.",
        expectedOutputEN: "Birds received into laying; 64 GP/cycle + 319 Parent/cycle orders processed.",
        expectedOutputAR: "الطيور مستلمة في البياض؛ 64 أمراً GP/دورة + 319 أمراً أصلياً/دورة.",
      },
      {
        id: "pp-lpp-s5",
        stepNumber: 5,
        titleEN: "Production Order TECO & Usage Decision",
        titleAR: "الإغلاق التقني وقرار الاستخدام",
        tCode: "CO02/QA32",
        role: "Production Planner",
        whatToDoEN: "Set the pre-production order to TECO in CO02, then make the inspection lot usage decision in QA32.",
        whatToDoAR: "ضع أمر ما قبل الإنتاج في حالة TECO في CO02، ثم اتخذ قرار استخدام فرقة الفحص في QA32.",
        whatSAPDoesEN: "SAP closes the order and records the QM decision.",
        whatSAPDoesAR: "يغلق SAP الأمر ويسجّل قرار QM.",
        expectedOutputEN: "Pre-production order closed; birds transferred to laying phase.",
        expectedOutputAR: "أمر ما قبل الإنتاج مغلق؛ الطيور منقولة إلى مرحلة البياض.",
      },
    ],
  },
  ...
  {
    id: "pp-rearing-cycle-planning",
    icon: "📋",
    duration: "4–8 hours",
    titleEN: "Rearing Cycle Planning",
    titleAR: "تخطيط دورة التربية",
    descriptionEN: "Plan the rearing production cycle for parent, C.Layer, and GP flocks: run MPS, convert planned orders, assign WBS and houses, adjust operations and lab dates, and release orders.",
    descriptionAR: "تخطيط دورة إنتاج التربية للقطعان الأصلية وقطيع C.Layer وGP: تشغيل MPS وتحويل الأوامر المخططة وتعيين WBS والمزارع وضبط العمليات وتواريخ المختبر وإصدار الأوامر.",
    module: "PP",
    roles: ["Production Planner", "MRP Controller"],
    steps: [
      {
        id: "pp-rcp-s1",
        stepNumber: 1,
        titleEN: "Check Old Requirements & Run MPS",
        titleAR: "التحقق من المتطلبات القديمة وتشغيل MPS",
        tCode: "MD04/MD40",
        role: "MRP Controller",
        whatToDoEN: "Verify old requirements are closed (MD04), then run MPS with quota arrangements (MD40) for rearing plants.",
        whatToDoAR: "تحقق من إغلاق المتطلبات القديمة (MD04)، ثم شغّل MPS مع ترتيبات الحصص (MD40) لمصانع التربية.",
        whatSAPDoesEN: "SAP runs MPS and creates planned orders for rearing cycles.",
        whatSAPDoesAR: "يشغّل SAP MPS وينشئ أوامر مخططة لدورات التربية.",
        expectedOutputEN: "MPS executed; planned orders created for rearing.",
        expectedOutputAR: "MPS منفَّذ؛ الأوامر المخططة منشأة للتربية.",
      },
      {
        id: "pp-rcp-s2",
        stepNumber: 2,
        titleEN: "Convert to Production Orders & Assign WBS/House",
        titleAR: "تحويل إلى أوامر إنتاج وتعيين WBS/المزرعة",
        tCode: "CO40/CO41/CO01",
        role: "Production Planner",
        whatToDoEN: "Convert planned orders to production orders and assign WBS element, house, and section to each order.",
        whatToDoAR: "حوّل الأوامر المخططة إلى أوامر إنتاج وعيّن عنصر WBS والمزرعة والقسم لكل أمر.",
        whatSAPDoesEN: "SAP creates production orders with WBS and house assignments.",
        whatSAPDoesAR: "ينشئ SAP أوامر إنتاج مع تعيينات WBS والمزرعة.",
        expectedOutputEN: "~223 production orders created per cycle.",
        expectedOutputAR: "~223 أمر إنتاج منشأ لكل دورة.",
      },
      {
        id: "pp-rcp-s3",
        stepNumber: 3,
        titleEN: "Adjust Operations & Components",
        titleAR: "ضبط العمليات والمكونات",
        tCode: "CO02",
        role: "Production Planner",
        whatToDoEN: "In CO02, adjust QM limits, component backflush storage locations, monthly lab test dates, vaccination operation dates, and house utilization distribution.",
        whatToDoAR: "في CO02، اضبط حدود QM ومواقع تخزين السحب التلقائي للمكونات وتواريخ الاختبارات المختبرية الشهرية وتواريخ عمليات التطعيم وتوزيع استخدام المزرعة.",
        whatSAPDoesEN: "SAP updates production order operations and components.",
        whatSAPDoesAR: "يحدّث SAP عمليات ومكونات أمر الإنتاج.",
        expectedOutputEN: "All operations and components adjusted per cycle requirements.",
        expectedOutputAR: "جميع العمليات والمكونات مضبوطة وفق متطلبات الدورة.",
      },
      {
        id: "pp-rcp-s4",
        stepNumber: 4,
        ...
        tCode: "CO02/CO05N",
        role: "Production Planner",
        whatToDoEN: "Release all rearing production orders using CO02 individually or CO05N collectively.",
        whatToDoAR: "أصدر جميع أوامر إنتاج التربية باستخدام CO02 فردياً أو CO05N جماعياً.",
        whatSAPDoesEN: "SAP sets orders to Released status.",
        whatSAPDoesAR: "يضع SAP الأوامر في حالة الإصدار.",
        expectedOutputEN: "All rearing orders released for execution.",
        expectedOutputAR: "جميع أوامر التربية مُصدَرة للتنفيذ.",
      },
      {
        id: "pp-rcp-s5",
        stepNumber: 5,
        titleEN: "Send Orders to PHD/Rearing Teams",
        titleAR: "إرسال الأوامر إلى فرق PHD/التربية",
        tCode: "Email/COOIS",
        role: "Production Planner",
        whatToDoEN: "Export the production order list from COOIS and send to PHD/Rearing teams for execution.",
        whatToDoAR: "صدّر قائمة أوامر الإنتاج من COOIS وأرسلها إلى فرق PHD/التربية للتنفيذ.",
        whatSAPDoesEN: "COOIS provides order list for communication.",
        whatSAPDoesAR: "يوفر COOIS قائمة الأوامر للتواصل.",
        expectedOutputEN: "Orders communicated to rearing teams (plants 1230/1260/3300).",
        expectedOutputAR: "الأوامر مُبلَّغ بها إلى فرق التربية (مصانع 1230/1260/3300).",
      },
    ],
  },
  ...
  {
    id: "pp-rearing-growing",
    icon: "🐥",
    duration: "Daily (rearing cycle)",
    titleEN: "Rearing Growing",
    titleAR: "تربية قطيع التربية",
    descriptionEN: "Daily execution of rearing growing: receive DOC, confirm daily activities with backflush, transfer birds at end of cycle, and close order with TECO and usage decision.",
    descriptionAR: "التنفيذ اليومي لتربية القطيع: استلام DOC وتأكيد الأنشطة اليومية مع السحب التلقائي ونقل الطيور في نهاية الدورة وإغلاق الأمر بـ TECO وقرار الاستخدام.",
    module: "PP",
    roles: ["Production Planner", "Farm Supervisor", "Quality Inspector"],
    steps: [
      {
        id: "pp-rg-s1",
        stepNumber: 1,
        titleEN: "Receive DOC & Adjust Order",
        titleAR: "استلام DOC وضبط الأمر",
        tCode: "MIGO_GR/CO02",
        role: "Farm Supervisor",
        whatToDoEN: "Post GR for DOC purchase order at house store (Mvt 101), then adjust order target qty/dates in CO02.",
        whatToDoAR: "رحّل استلام DOC من أمر الشراء في مخزن المزرعة (نوع 101)، ثم اضبط الكمية المستهدفة والتواريخ في CO02.",
        whatSAPDoesEN: "SAP receives DOC into house inventory and updates the production order.",
        whatSAPDoesAR: "يستلم SAP DOC في مخزون المزرعة ويحدّث أمر الإنتاج.",
        expectedOutputEN: "DOC received; order adjusted to actual numbers.",
        expectedOutputAR: "DOC مستلَم؛ الأمر مضبوط على الأرقام الفعلية.",
      },
      {
        id: "pp-rg-s2",
        stepNumber: 2,
        ...
        tCode: "QA32",
        role: "Farm Supervisor",
        whatToDoEN: "Record daily QM data (DoA, Culls, Mortality) in QA32.",
        whatToDoAR: "سجّل بيانات QM اليومية (النافقة عند الوصول، المستبعدات، النفوق) في QA32.",
        whatSAPDoesEN: "SAP records inspection lot results.",
        whatSAPDoesAR: "يسجّل SAP نتائج فرقة الفحص.",
        expectedOutputEN: "Daily mortality and culls recorded.",
        expectedOutputAR: "النفوق اليومي والمستبعدات مسجّلة.",
      },
      {
        id: "pp-rg-s3",
        stepNumber: 3,
        ...
        tCode: "CO11N",
        role: "Farm Supervisor",
        whatToDoEN: "Post daily confirmations in CO11N with backflush of feed and materials (Mvt 261).",
        whatToDoAR: "رحّل التأكيدات اليومية في CO11N مع السحب التلقائي للعلف والمواد (نوع 261).",
        whatSAPDoesEN: "SAP posts confirmations and backflushes consumption.",
        whatSAPDoesAR: "يرحّل SAP التأكيدات ويسحب الاستهلاك.",
        expectedOutputEN: "Daily activities confirmed.",
        expectedOutputAR: "الأنشطة اليومية مؤكدة.",
      },
      {
        id: "pp-rg-s4",
        stepNumber: 4,
        titleEN: "GR of Birds at Transfer (Auto GR)",
        titleAR: "استلام الطيور عند النقل (استلام تلقائي)",
        tCode: "CO11N",
        role: "Farm Supervisor",
        whatToDoEN: "At end of rearing, adjust GR operation to ZQM3 and post final confirmation to trigger auto GR (Mvt 101) using ZPPH3 balance.",
        whatToDoAR: "في نهاية التربية، اضبط عملية الاستلام على ZQM3 ورحّل التأكيد النهائي لتشغيل الاستلام التلقائي (نوع 101) باستخدام ميزان ZPPH3.",
        whatSAPDoesEN: "SAP automatically receives transferred birds into destination inventory.",
        whatSAPDoesAR: "يستلم SAP تلقائياً الطيور المنقولة في مخزون الوجهة.",
        expectedOutputEN: "Birds transferred; 115 parent/cycle + 12 layer/cycle + 96 GP/cycle.",
        expectedOutputAR: "الطيور منقولة؛ 115 أصلياً/دورة + 12 قاطع/دورة + 96 GP/دورة.",
      },
      {
        id: "pp-rg-s5",
        stepNumber: 5,
        titleEN: "TECO & Usage Decision",
        titleAR: "الإغلاق التقني وقرار الاستخدام",
        tCode: "CO02/QA32",
        role: "Production Planner",
        whatToDoEN: "Set production order to TECO in CO02 and make usage decision in QA32.",
        whatToDoAR: "ضع أمر الإنتاج في وضع TECO في CO02 واتخذ قرار الاستخدام في QA32.",
        whatSAPDoesEN: "SAP closes the order and records the final QM decision.",
        whatSAPDoesAR: "يغلق SAP الأمر ويسجّل قرار QM النهائي.",
        expectedOutputEN: "Rearing order closed; cycle complete.",
        expectedOutputAR: "أمر التربية مغلق؛ الدورة مكتملة.",
      },
    ],
  },
  ...
  {
    id: "pp-feed-mill-daily-planning",
    icon: "🌾",
    duration: "1–3 hours",
    titleEN: "Feed Mill Daily Planning",
    titleAR: "التخطيط اليومي لمصنع الأعلاف",
    descriptionEN: "Daily feed mill planning: update SOP demand plans, transfer to demand management, run MPS, and release stock transfer requests for raw material procurement.",
    descriptionAR: "التخطيط اليومي لمصنع الأعلاف: تحديث خطط طلب SOP والنقل إلى إدارة الطلب وتشغيل MPS وإصدار طلبات نقل المخزون لشراء المواد الخام.",
    module: "PP",
    roles: ["Feed Mill Production Planner"],
    steps: [
      {
        id: "pp-fmdp-s1",
        stepNumber: 1,
        titleEN: "Create STOs from Farms to Feed Mill",
        titleAR: "إنشاء STOs من المزارع إلى مصنع الأعلاف",
        tCode: "ME21N",
        role: "Feed Mill Production Planner",
        whatToDoEN: "Create STOs from farms to feed mill plants to transfer raw materials needed for daily production.",
        whatToDoAR: "أنشئ STOs من المزارع إلى مصانع الأعلاف لنقل المواد الخام المطلوبة للإنتاج اليومي.",
        whatSAPDoesEN: "SAP creates inter-plant transfer orders for raw material supply.",
        whatSAPDoesAR: "ينشئ SAP أوامر نقل بين المصانع لتوريد المواد الخام.",
        expectedOutputEN: "Raw material STOs created.",
        expectedOutputAR: "STOs المواد الخام منشأة.",
      },
      {
        id: "pp-fmdp-s2",
        stepNumber: 2,
        titleEN: "Update SOP Demand Plan",
        titleAR: "تحديث خطة طلب SOP",
        tCode: "MC88/MC82",
        role: "Feed Mill Production Planner",
        whatToDoEN: "Update the SOP demand plan for feed products (GP company feed and fish feed) using MC88/MC82.",
        whatToDoAR: "حدّث خطة طلب SOP لمنتجات العلف (علف شركة GP وعلف الأسماك) باستخدام MC88/MC82.",
        whatSAPDoesEN: "SAP updates the SOP plan with revised demand figures.",
        whatSAPDoesAR: "يحدّث SAP خطة SOP بأرقام الطلب المعدّلة.",
        expectedOutputEN: "SOP demand plan updated.",
        expectedOutputAR: "خطة طلب SOP محدّثة.",
      },
      {
        id: "pp-fmdp-s3",
        stepNumber: 3,
        titleEN: "Transfer to Demand Management & Check PIRs",
        titleAR: "النقل إلى إدارة الطلب والتحقق من PIRs",
        tCode: "MC74/MC75/MD63",
        role: "Feed Mill Production Planner",
        whatToDoEN: "Transfer SOP plan to demand management (MC74/MC75) and verify transferred PIRs in MD63.",
        whatToDoAR: "انقل خطة SOP إلى إدارة الطلب (MC74/MC75) وتحقق من PIRs المنقولة في MD63.",
        whatSAPDoesEN: "SAP creates PIRs in demand management for the feed mill.",
        whatSAPDoesAR: "ينشئ SAP PIRs في إدارة الطلب لمصنع الأعلاف.",
        expectedOutputEN: "PIRs created and verified in demand management.",
        expectedOutputAR: "PIRs منشأة ومحققة في إدارة الطلب.",
      },
      {
        id: "pp-fmdp-s4",
        stepNumber: 4,
        ...
        tCode: "MD01N",
        role: "Feed Mill Production Planner",
        whatToDoEN: "Run MD01N to execute MPS for feed mill plants (1140–1190) and generate ~25 planned orders/day.",
        whatToDoAR: "شغّل MD01N لتنفيذ MPS لمصانع الأعلاف (1140–1190) وإنشاء ~25 أمراً مخططاً يومياً.",
        whatSAPDoesEN: "SAP runs MPS and creates planned production orders.",
        whatSAPDoesAR: "يشغّل SAP MPS وينشئ أوامر الإنتاج المخططة.",
        expectedOutputEN: "~25 planned orders/day generated for feed mills.",
        expectedOutputAR: "~25 أمراً مخططاً/يوم منشأ لمصانع الأعلاف.",
      },
      {
        id: "pp-fmdp-s5",
        stepNumber: 5,
        titleEN: "Release STRs & Convert to STOs",
        titleAR: "إصدار STRs وتحويلها إلى STOs",
        tCode: "MD04/ME54N/ME21N",
        role: "Feed Mill Production Planner",
        whatToDoEN: "Release stock transfer requests (MD04/ME54N) and convert to weekly STOs for raw material procurement (ME21N).",
        whatToDoAR: "أصدر طلبات نقل المخزون (MD04/ME54N) وحوّلها إلى STOs أسبوعية لشراء المواد الخام (ME21N).",
        whatSAPDoesEN: "SAP releases STRs and creates procurement STOs for raw materials.",
        whatSAPDoesAR: "يُصدر SAP STRs وينشئ STOs الشراء للمواد الخام.",
        expectedOutputEN: "Raw material STOs created for weekly supply.",
        expectedOutputAR: "STOs المواد الخام منشأة للتوريد الأسبوعي.",
      },
    ],
  },
  ...
  {
    id: "pp-feed-mill-manufacturing",
    icon: "⚙️",
    duration: "Daily",
    titleEN: "Feed Mill Manufacturing Execution",
    titleAR: "تنفيذ تصنيع مصنع الأعلاف",
    descriptionEN: "Daily feed mill manufacturing: convert planned to production orders, stage raw materials, transfer from warehouse, receive via STO, release and confirm production orders (YPP2/YPP3), and TECO.",
    descriptionAR: "تصنيع مصنع الأعلاف اليومي: تحويل المخطط إلى أوامر إنتاج وتجهيز المواد الخام ونقلها من المستودع والاستلام عبر STO وإصدار وتأكيد أوامر الإنتاج (YPP2/YPP3) وتنفيذ TECO.",
    module: "PP",
    roles: ["Feed Mill Production Planner", "Warehouse Staff", "Production Supervisor"],
    steps: [
      {
        id: "pp-fmm-s1",
        stepNumber: 1,
        titleEN: "Convert Planned to Production Orders",
        titleAR: "تحويل المخطط إلى أوامر إنتاج",
        tCode: "MD04/CO40/CO41",
        role: "Feed Mill Production Planner",
        whatToDoEN: "Convert MPS planned orders to production orders (YPP2 for finished product, YPP3 for semi-finished).",
        whatToDoAR: "حوّل الأوامر المخططة في MPS إلى أوامر إنتاج (YPP2 للمنتج النهائي، YPP3 لشبه المنتج).",
        whatSAPDoesEN: "SAP creates production orders of types YPP2 and YPP3.",
        whatSAPDoesAR: "ينشئ SAP أوامر الإنتاج من الأنواع YPP2 وYPP3.",
        expectedOutputEN: "~25 production orders/day created.",
        expectedOutputAR: "~25 أمر إنتاج/يوم منشأ.",
      },
      {
        id: "pp-fmm-s2",
        stepNumber: 2,
        ...
        whatToDoEN: "Use ZMF60 or MB21 to request materials from RM warehouse to the production area for staging.",
        whatToDoAR: "استخدم ZMF60 أو MB21 لطلب المواد من مستودع المواد الخام إلى منطقة الإنتاج للتجهيز.",
        whatSAPDoesEN: "SAP creates material reservations for production.",
        whatSAPDoesAR: "ينشئ SAP حجوزات المواد للإنتاج.",
        expectedOutputEN: "Material staging requests created.",
        expectedOutputAR: "طلبات تجهيز المواد منشأة.",
      },
      {
        id: "pp-fmm-s3",
        stepNumber: 3,
        titleEN: "Transfer Raw Materials to Production Area",
        titleAR: "نقل المواد الخام إلى منطقة الإنتاج",
        tCode: "MIGO_TR",
        role: "Warehouse Staff",
        whatToDoEN: "Post transfer order using MIGO_TR with Movement Type 311 to move raw materials from RM warehouse to production area.",
        whatToDoAR: "رحّل أمر النقل باستخدام MIGO_TR ونوع الحركة 311 لنقل المواد الخام من مستودع المواد الخام إلى منطقة الإنتاج.",
        whatSAPDoesEN: "SAP posts the stock transfer and updates inventory locations.",
        whatSAPDoesAR: "يرحّل SAP نقل المخزون ويحدّث مواقع المخزون.",
        expectedOutputEN: "Raw materials transferred (Mvt 311) to production area.",
        expectedOutputAR: "المواد الخام منقولة (نوع 311) إلى منطقة الإنتاج.",
      },
      {
        id: "pp-fmm-s4",
        stepNumber: 4,
        titleEN: "Receive Premixes via STO",
        titleAR: "استلام المستحضرات عبر STO",
        tCode: "ME21N/MIGO_GI/MIGO_GR",
        role: "Warehouse Staff",
        whatToDoEN: "Create STO for premixes and additives from other feed mill plants (ME21N), post GI (Mvt 351) and GR (Mvt 101).",
        whatToDoAR: "أنشئ STO للمستحضرات والمضافات من مصانع الأعلاف الأخرى (ME21N)، رحّل إصدار (نوع 351) واستلام (نوع 101) البضائع.",
        whatSAPDoesEN: "SAP transfers premixes/additives between feed mill plants.",
        whatSAPDoesAR: "ينقل SAP المستحضرات/المضافات بين مصانع الأعلاف.",
        expectedOutputEN: "Premixes received at production plant.",
        expectedOutputAR: "المستحضرات مستلمة في مصنع الإنتاج.",
      },
      {
        id: "pp-fmm-s5",
        stepNumber: 5,
        titleEN: "Release & Confirm Production Order",
        titleAR: "إصدار وتأكيد أمر الإنتاج",
        tCode: "CO02/CO11N",
        role: "Production Supervisor",
        whatToDoEN: "Release the production order (CO02), then confirm production with backflush and GR of finished feed (CO11N).",
        whatToDoAR: "أصدر أمر الإنتاج (CO02)، ثم أكّد الإنتاج مع السحب التلقائي واستلام العلف النهائي (CO11N).",
        whatSAPDoesEN: "SAP confirms production, backflushes raw materials, and posts GR of finished feed.",
        whatSAPDoesAR: "يؤكد SAP الإنتاج ويسحب المواد الخام ويرحّل استلام العلف النهائي.",
        expectedOutputEN: "Production confirmed; finished feed received in inventory.",
        expectedOutputAR: "الإنتاج مؤكد؛ العلف النهائي مستلَم في المخزون.",
      },
      {
        id: "pp-fmm-s6",
        stepNumber: 6,
        ...
        tCode: "CO02",
        role: "Feed Mill Production Planner",
        whatToDoEN: "Set completed production orders to TECO status in CO02.",
        whatToDoAR: "ضع أوامر الإنتاج المكتملة في حالة TECO في CO02.",
        whatSAPDoesEN: "SAP closes the production order and clears open reservations.",
        whatSAPDoesAR: "يغلق SAP أمر الإنتاج ويُغلق الحجوزات المفتوحة.",
        expectedOutputEN: "Feed production orders closed.",
        expectedOutputAR: "أوامر إنتاج الأعلاف مغلقة.",
      },
    ],
  },
  ...
  {
    id: "pp-create-new-product",
    icon: "🆕",
    duration: "1–3 days",
    titleEN: "Create New Product",
    titleAR: "إنشاء منتج جديد",
    descriptionEN: "End-to-end master data setup for a new product: create material master, BOM, routing, production version, quota arrangement, standard cost estimate, and sales price condition.",
    descriptionAR: "إعداد البيانات الرئيسية الكاملة لمنتج جديد: إنشاء بيانات المواد الرئيسية وBOM والتوجيه وإصدار الإنتاج وترتيبات الحصص وتقدير التكلفة المعيارية وشرط سعر المبيعات.",
    module: "PP",
    roles: ["PP Master Data Admin"],
    steps: [
      {
        id: "pp-cnp-s1",
        stepNumber: 1,
        titleEN: "Create Material Master",
        titleAR: "إنشاء بيانات المادة الرئيسية",
        tCode: "MM01",
        role: "PP Master Data Admin",
        whatToDoEN: "Create product and component material masters in MM01, extending to all plants and distribution centers.",
        whatToDoAR: "أنشئ بيانات المادة الرئيسية للمنتج والمكونات في MM01، مع التوسيع لجميع المصانع ومراكز التوزيع.",
        whatSAPDoesEN: "SAP creates material master records with all required views.",
        whatSAPDoesAR: "ينشئ SAP سجلات البيانات الرئيسية للمواد بجميع الأوجه المطلوبة.",
        expectedOutputEN: "Material masters created for product and components.",
        expectedOutputAR: "البيانات الرئيسية للمواد منشأة للمنتج والمكونات.",
      },
      {
        id: "pp-cnp-s2",
        stepNumber: 2,
        titleEN: "Create BOM & Routing",
        titleAR: "إنشاء BOM والتوجيه",
        tCode: "CS01/CA01",
        role: "PP Master Data Admin",
        whatToDoEN: "Create Bill of Materials (CS01) and Routing (CA01) for the new product.",
        whatToDoAR: "أنشئ قائمة المكونات (CS01) والتوجيه (CA01) للمنتج الجديد.",
        whatSAPDoesEN: "SAP creates BOM and routing records for the product.",
        whatSAPDoesAR: "ينشئ SAP سجلات BOM والتوجيه للمنتج.",
        expectedOutputEN: "BOM and routing created.",
        expectedOutputAR: "BOM والتوجيه منشأ.",
      },
      {
        id: "pp-cnp-s3",
        stepNumber: 3,
        titleEN: "Create Production Version & Quota Arrangement",
        titleAR: "إنشاء إصدار الإنتاج وترتيبات الحصص",
        tCode: "C223/MEQ1",
        role: "PP Master Data Admin",
        whatToDoEN: "Create production version (C223) linking BOM and routing, and quota arrangement (MEQ1) if needed.",
        whatToDoAR: "أنشئ إصدار الإنتاج (C223) بربط BOM والتوجيه، وترتيبات الحصص (MEQ1) إذا لزم.",
        whatSAPDoesEN: "SAP creates production version and quota arrangement for MRP.",
        whatSAPDoesAR: "ينشئ SAP إصدار الإنتاج وترتيبات الحصص لـ MRP.",
        expectedOutputEN: "Production version and quota arrangement created.",
        expectedOutputAR: "إصدار الإنتاج وترتيبات الحصص منشأة.",
      },
      {
        id: "pp-cnp-s4",
        stepNumber: 4,
        titleEN: "Create Standard Cost Estimate & Sales Price",
        titleAR: "إنشاء تقدير التكلفة المعيارية وسعر المبيعات",
        tCode: "CK11N/VK11",
        role: "PP Master Data Admin",
        whatToDoEN: "Create standard cost estimate (CK11N) for the product and maintain sales price conditions (VK11).",
        whatToDoAR: "أنشئ تقدير التكلفة المعيارية (CK11N) للمنتج وحدّد شروط سعر المبيعات (VK11).",
        whatSAPDoesEN: "SAP calculates and saves standard cost; creates sales price condition record.",
        whatSAPDoesAR: "يحسب SAP ويحفظ التكلفة المعيارية؛ ينشئ سجل شرط سعر المبيعات.",
        expectedOutputEN: "Standard cost and sales price created; ~20 new products/year.",
        expectedOutputAR: "التكلفة المعيارية وسعر المبيعات منشأ؛ ~20 منتجاً جديداً/سنة.",
      },
    ],
  },
  ...
  {
    id: "pp-create-house-hatcher",
    icon: "🏗️",
    duration: "1–2 days",
    titleEN: "Create New House / Hatcher / Setter",
    titleAR: "إنشاء مزرعة/حاضنة/مفقسة جديدة",
    descriptionEN: "Master data setup for a new house, hatcher, or setter: create storage location, WBS element, update work center, extend materials, and create internal order for laying houses.",
    descriptionAR: "إعداد البيانات الرئيسية لمزرعة أو حاضنة أو مفقسة جديدة: إنشاء موقع التخزين وعنصر WBS وتحديث مركز العمل وتوسيع المواد وإنشاء أمر داخلي لمزارع البياض.",
    module: "PP",
    roles: ["PP Master Data Admin"],
    steps: [
      {
        id: "pp-chh-s1",
        stepNumber: 1,
        titleEN: "Create Storage Location & WBS Element",
        titleAR: "إنشاء موقع التخزين وعنصر WBS",
        tCode: "Config/CJ20N",
        role: "PP Master Data Admin",
        whatToDoEN: "Create the storage location via configuration and create the WBS element in CJ20N for the new house.",
        whatToDoAR: "أنشئ موقع التخزين عبر الإعداد وأنشئ عنصر WBS في CJ20N للمزرعة الجديدة.",
        whatSAPDoesEN: "SAP creates the storage location and WBS element.",
        whatSAPDoesAR: "ينشئ SAP موقع التخزين وعنصر WBS.",
        expectedOutputEN: "Storage location and WBS element created.",
        expectedOutputAR: "موقع التخزين وعنصر WBS منشأ.",
      },
      {
        id: "pp-chh-s2",
        stepNumber: 2,
        titleEN: "Update Work Center & Quota Arrangement",
        titleAR: "تحديث مركز العمل وترتيبات الحصص",
        tCode: "CR02/MEQ1",
        role: "PP Master Data Admin",
        whatToDoEN: "Update the farm work center (CR02) with the new house capacity and update quota arrangements (MEQ1).",
        whatToDoAR: "حدّث مركز عمل المزرعة (CR02) بطاقة المزرعة الجديدة وحدّث ترتيبات الحصص (MEQ1).",
        whatSAPDoesEN: "SAP updates work center capacity and quota arrangement.",
        whatSAPDoesAR: "يحدّث SAP طاقة مركز العمل وترتيبات الحصص.",
        expectedOutputEN: "Work center and quota updated.",
        expectedOutputAR: "مركز العمل والحصص محدّث.",
      },
      {
        id: "pp-chh-s3",
        stepNumber: 3,
        titleEN: "Extend Materials to New Storage Location",
        titleAR: "توسيع المواد إلى موقع التخزين الجديد",
        tCode: "MMSC/MMSC_MASS",
        role: "PP Master Data Admin",
        whatToDoEN: "Extend all required materials to the new storage location using MMSC or MMSC_MASS.",
        whatToDoAR: "وسّع جميع المواد المطلوبة إلى موقع التخزين الجديد باستخدام MMSC أو MMSC_MASS.",
        whatSAPDoesEN: "SAP extends material master records to include the new storage location.",
        whatSAPDoesAR: "يوسّع SAP سجلات البيانات الرئيسية للمواد لتشمل موقع التخزين الجديد.",
        expectedOutputEN: "Materials extended to new storage location.",
        expectedOutputAR: "المواد موسَّعة إلى موقع التخزين الجديد.",
      },
      {
        id: "pp-chh-s4",
        stepNumber: 4,
        titleEN: "Create Internal Order & Assign Roles",
        titleAR: "إنشاء الأمر الداخلي وتعيين الأدوار",
        tCode: "KO01/PFCG",
        role: "PP Master Data Admin",
        whatToDoEN: "Create an internal order (KO01) for parent/C.Layer laying houses, then assign storage locations to user roles (PFCG).",
        whatToDoAR: "أنشئ أمراً داخلياً (KO01) لمزارع البياض الأصلية وC.Layer، ثم عيّن مواقع التخزين لأدوار المستخدمين (PFCG).",
        whatSAPDoesEN: "SAP creates internal order and updates role authorizations.",
        whatSAPDoesAR: "ينشئ SAP الأمر الداخلي ويحدّث تفويضات الأدوار.",
        expectedOutputEN: "Internal order created; user roles updated. (~10/year)",
        expectedOutputAR: "الأمر الداخلي منشأ؛ أدوار المستخدمين محدّثة. (~10/سنة)",
      },
    ],
  },
  ...
  {
    id: "pp-create-farm-hatchery",
    icon: "🏭",
    duration: "2–5 days",
    titleEN: "Create New Farm / Hatchery",
    titleAR: "إنشاء مزرعة/مفرخة جديدة",
    descriptionEN: "Full master data setup for a new farm or hatchery: create cost center, work center, routing, production version, extend materials, and assign storage locations to user roles.",
    descriptionAR: "الإعداد الكامل للبيانات الرئيسية لمزرعة أو مفرخة جديدة: إنشاء مركز التكلفة ومركز العمل والتوجيه وإصدار الإنتاج وتوسيع المواد وتعيين مواقع التخزين لأدوار المستخدمين.",
    module: "PP",
    roles: ["PP Master Data Admin"],
    steps: [
      {
        ...
        tCode: "Config/CJ20N",
        role: "PP Master Data Admin",
        whatToDoEN: "Create storage locations via configuration and WBS element in CJ20N for the new farm/hatchery.",
        whatToDoAR: "أنشئ مواقع التخزين عبر الإعداد وعنصر WBS في CJ20N للمزرعة/المفرخة الجديدة.",
        whatSAPDoesEN: "SAP creates storage location and WBS element.",
        whatSAPDoesAR: "ينشئ SAP موقع التخزين وعنصر WBS.",
        expectedOutputEN: "Storage location and WBS created.",
        expectedOutputAR: "موقع التخزين وWBS منشأ.",
      },
      {
        id: "pp-cfh-s2",
        stepNumber: 2,
        titleEN: "Create Cost Center & Activity Price",
        titleAR: "إنشاء مركز التكلفة وسعر النشاط",
        tCode: "KS01/KP26",
        role: "PP Master Data Admin",
        whatToDoEN: "Create a cost center (KS01) for the new farm/hatchery and define activity prices (KP26).",
        whatToDoAR: "أنشئ مركز تكلفة (KS01) للمزرعة/المفرخة الجديدة وحدّد أسعار الأنشطة (KP26).",
        whatSAPDoesEN: "SAP creates cost center and activity type price records.",
        whatSAPDoesAR: "ينشئ SAP مركز التكلفة وسجلات سعر نوع النشاط.",
        expectedOutputEN: "Cost center and activity prices created.",
        expectedOutputAR: "مركز التكلفة وأسعار الأنشطة منشأة.",
      },
      {
        id: "pp-cfh-s3",
        stepNumber: 3,
        titleEN: "Create Work Center, Routing & Production Version",
        titleAR: "إنشاء مركز العمل والتوجيه وإصدار الإنتاج",
        tCode: "CR01/CA01/C223",
        role: "PP Master Data Admin",
        whatToDoEN: "Create work center (CR01), routing (CA01), and production version (C223) for the new farm/hatchery.",
        whatToDoAR: "أنشئ مركز العمل (CR01) والتوجيه (CA01) وإصدار الإنتاج (C223) للمزرعة/المفرخة الجديدة.",
        whatSAPDoesEN: "SAP creates all production master data records.",
        whatSAPDoesAR: "ينشئ SAP جميع سجلات البيانات الرئيسية للإنتاج.",
        expectedOutputEN: "Work center, routing, and production version created.",
        expectedOutputAR: "مركز العمل والتوجيه وإصدار الإنتاج منشأة.",
      },
      {
        id: "pp-cfh-s4",
        stepNumber: 4,
        titleEN: "Update Quota, Extend Materials & Assign Roles",
        titleAR: "تحديث الحصص وتوسيع المواد وتعيين الأدوار",
        tCode: "MEQ1/MMSC_MASS/PFCG",
        role: "PP Master Data Admin",
        whatToDoEN: "Update quota arrangements (MEQ1), extend materials to new storage locations (MMSC_MASS), and assign locations to user roles (PFCG).",
        whatToDoAR: "حدّث ترتيبات الحصص (MEQ1) ووسّع المواد إلى مواقع التخزين الجديدة (MMSC_MASS) وعيّن المواقع لأدوار المستخدمين (PFCG).",
        whatSAPDoesEN: "SAP completes the full setup for the new farm/hatchery.",
        whatSAPDoesAR: "يُكمل SAP الإعداد الكامل للمزرعة/المفرخة الجديدة.",
        expectedOutputEN: "New farm/hatchery fully configured in SAP. (~1/year)",
        expectedOutputAR: "المزرعة/المفرخة الجديدة مُعدَّة بالكامل في SAP. (~1/سنة)",
      },
    ],
  },
  ...
  {
    id: "pp-agriculture-execution",
    icon: "🌱",
    duration: "Daily",
    titleEN: "Agriculture Execution",
    titleAR: "تنفيذ قطاع الزراعة",
    descriptionEN: "Daily agriculture plant execution: post GR via REM collective confirmation, create and deliver sales orders for agriculture customers, and generate billing documents.",
    descriptionAR: "التنفيذ اليومي لمصنع الزراعة: ترحيل الاستلام عبر تأكيد REM الجماعي وإنشاء وتسليم أوامر المبيعات لعملاء الزراعة وإنشاء مستندات الفوترة.",
    module: "PP",
    roles: ["Agriculture Production Planner", "Sales Representative"],
    steps: [
      {
        id: "pp-ag-s1",
        stepNumber: 1,
        titleEN: "GR via REM Collective Confirmation",
        titleAR: "الاستلام عبر تأكيد REM الجماعي",
        tCode: "MF42N",
        role: "Agriculture Production Planner",
        whatToDoEN: "Run MF42N to post collective GR confirmation for each finished agriculture product per posting date (~300 confirmations/day).",
        whatToDoAR: "شغّل MF42N لترحيل تأكيد الاستلام الجماعي لكل منتج زراعي نهائي لكل تاريخ ترحيل (~300 تأكيد/يوم).",
        whatSAPDoesEN: "SAP posts GR for finished products and backflushes consumed materials.",
        whatSAPDoesAR: "يرحّل SAP استلام المنتجات النهائية ويسحب المواد المستهلكة.",
        expectedOutputEN: "~300 collective GR confirmations posted; agriculture plant 4100.",
        expectedOutputAR: "~300 تأكيد استلام جماعي مرحّل؛ مصنع الزراعة 4100.",
      },
      {
        id: "pp-ag-s2",
        stepNumber: 2,
        titleEN: "Create Sales Order for Agriculture Customers",
        titleAR: "إنشاء أمر مبيعات لعملاء الزراعة",
        tCode: "VA01",
        role: "Sales Representative",
        whatToDoEN: "Create sales orders in VA01 for agriculture customers under company code 4000 (AWP Agriculture).",
        whatToDoAR: "أنشئ أوامر مبيعات في VA01 لعملاء الزراعة تحت رمز الشركة 4000 (الوطنية للزراعة).",
        whatSAPDoesEN: "SAP creates sales order and generates delivery requirements.",
        whatSAPDoesAR: "ينشئ SAP أمر المبيعات ويولّد متطلبات التسليم.",
        expectedOutputEN: "Agriculture sales orders created.",
        expectedOutputAR: "أوامر مبيعات الزراعة منشأة.",
      },
      {
        id: "pp-ag-s3",
        stepNumber: 3,
        titleEN: "Create Delivery & Goods Issue",
        titleAR: "إنشاء التسليم وإصدار البضائع",
        tCode: "VL10C/VL06G",
        role: "Sales Representative",
        whatToDoEN: "Create outbound delivery (VL10C) and post goods issue (VL06G) for agriculture products.",
        whatToDoAR: "أنشئ التسليم الصادر (VL10C) ورحّل إصدار البضائع (VL06G) للمنتجات الزراعية.",
        whatSAPDoesEN: "SAP creates delivery and posts GI, reducing finished goods inventory.",
        whatSAPDoesAR: "ينشئ SAP التسليم ويرحّل إصدار البضائع مما يقلّل مخزون المنتجات النهائية.",
        expectedOutputEN: "Delivery created and goods issued.",
        expectedOutputAR: "التسليم منشأ والبضائع مُصدَرة.",
      },
      {
        id: "pp-ag-s4",
        stepNumber: 4,
        ...
        tCode: "VF01/VF04",
        role: "Sales Representative",
        whatToDoEN: "Create billing document (VF01 individually or VF04 collectively) for the agriculture customer invoice.",
        whatToDoAR: "أنشئ مستند الفوترة (VF01 فردياً أو VF04 جماعياً) لفاتورة عميل الزراعة.",
        whatSAPDoesEN: "SAP creates the billing document and posts revenue to FI.",
        whatSAPDoesAR: "ينشئ SAP مستند الفوترة ويرحّل الإيراد إلى FI.",
        expectedOutputEN: "Billing document created; revenue posted to company 4000.",
        expectedOutputAR: "مستند الفوترة منشأ؛ الإيراد مرحّل للشركة 4000.",
      },
    ],
  },
